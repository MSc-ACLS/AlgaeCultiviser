...
function hue2rgb(p4, q2, t9) {
  ...
  if (t9 > 1)
    t9 -= 1;
  if (t9 < 1 / 6)
    return p4 + (q2 - p4) * 6 * t9;
  if (t9 < 1 / 2)
    return q2;
  if (t9 < 2 / 3)
    return p4 + (q2 - p4) * (2 / 3 - t9) * 6;
  return p4;
}
function hslToRgb(h2, s4, l4) {
  ...
  return Math.round(r6 * 255) << 24 | Math.round(g4 * 255) << 16 | Math.round(b5 * 255) << 8;
}
...
function rgb2(r6, g4, b5, opacity) {
  return arguments.length === 1 ? rgbConvert(r6) : new Rgb(r6, g4, b5, opacity == null ? 1 : opacity);
}
function Rgb(r6, g4, b5, opacity) {
  this.r = +r6;
  this.g = +g4;
  this.b = +b5;
...
function hsla2(h2, s4, l4, a4) {
  if (a4 <= 0) h2 = s4 = l4 = NaN;
  else if (l4 <= 0 || l4 >= 1) h2 = s4 = NaN;
  else if (s4 <= 0) h2 = NaN;
  return new Hsl(h2, s4, l4, a4);
}
function hslConvert(o4) {
  ...
  o4 = o4.rgb();
  var r6 = o4.r / 255, g4 = o4.g / 255, b5 = o4.b / 255, min3 = Math.min(r6, g4, b5), max3 = Math.max(r6, g4, b5), h2 = NaN, s4 = max3 - min3, l4 = (max3 + min3) / 2;
  if (s4) {
    if (r6 === max3) h2 = (g4 - b5) / s4 + (g4 < b5) * 6;
    else if (g4 === max3) h2 = (b5 - r6) / s4 + 2;
    else h2 = (r6 - g4) / s4 + 4;
  ...
  return new Hsl(h2, s4, l4, o4.opacity);
}
...
function labConvert(o4) {
  ...
  var r6 = rgb2lrgb(o4.r), g4 = rgb2lrgb(o4.g), b5 = rgb2lrgb(o4.b), y4 = xyz2lab((0.2225045 * r6 + 0.7168786 * g4 + 0.0606169 * b5) / Yn), x4, z5;
  if (r6 === g4 && g4 === b5) x4 = z5 = y4;
  else {
    x4 = xyz2lab((0.4360747 * r6 + 0.3850649 * g4 + 0.1430804 * b5) / Xn);
    z5 = xyz2lab((0.0139322 * r6 + 0.0971045 * g4 + 0.7141733 * b5) / Zn);
  }
  return new Lab(116 * y4 - 16, 500 * (x4 - y4), 200 * (y4 - z5), o4.opacity);
}
function lab(l4, a4, b5, opacity) {
  return arguments.length === 1 ? labConvert(l4) : new Lab(l4, a4, b5, opacity == null ? 1 : opacity);
}
function Lab(l4, a4, b5, opacity) {
  this.l = +l4;
  this.a = +a4;
...
function cubehelixConvert(o4) {
  ...
  if (!(o4 instanceof Rgb)) o4 = rgbConvert(o4);
  var r6 = o4.r / 255, g4 = o4.g / 255, b5 = o4.b / 255, l4 = (BC_DA * b5 + ED * r6 - EB * g4) / (BC_DA + ED - EB), bl = b5 - l4, k5 = (E * (g4 - l4) - C * bl) / D, s4 = Math.sqrt(k5 * k5 + bl * bl) / (E * l4 * (1 - l4)), h2 = s4 ? Math.atan2(k5, bl) * degrees - 120 : NaN;
  return new Cubehelix(h2 < 0 ? h2 + 360 : h2, s4, l4, o4.opacity);
}
...
define_default(Cubehelix, cubehelix, extend(Color, {
  ...
  rgb() {
    var h2 = isNaN(this.h) ? 0 : (this.h + 120) * radians, l4 = +this.l, a4 = isNaN(this.s) ? 0 : this.s * l4 * (1 - l4), cosh2 = Math.cos(h2), sinh2 = Math.sin(h2);
    return new Rgb(
      255 * (l4 + a4 * (A * cosh2 + B * sinh2)),
      255 * (l4 + a4 * (C * cosh2 + D * sinh2)),
      255 * (l4 + a4 * (E * cosh2)),
      this.opacity
    );
  }
...
function exponential(a4, b5, y4) {
  return a4 = Math.pow(a4, y4), b5 = Math.pow(b5, y4) - a4, y4 = 1 / y4, function(t9) {
    return Math.pow(a4 + t9 * b5, y4);
  };
}
function hue(a4, b5) {
  var d3 = b5 - a4;
...
var rgb_default = function rgbGamma(y4) {
  ...
  function rgb3(start2, end) {
    var r6 = color2((start2 = rgb2(start2)).r, (end = rgb2(end)).r), g4 = color2(start2.g, end.g), b5 = color2(start2.b, end.b), opacity = nogamma(start2.opacity, end.opacity);
    return function(t9) {
      start2.r = r6(t9);
      start2.g = g4(t9);
      start2.b = b5(t9);
...
function rgbSpline(spline) {
  return function(colors3) {
    var n6 = colors3.length, r6 = new Array(n6), g4 = new Array(n6), b5 = new Array(n6), i5, color2;
    for (i5 = 0; i5 < n6; ++i5) {
...
function numberArray_default(a4, b5) {
  if (!b5) b5 = [];
  var n6 = a4 ? Math.min(b5.length, a4.length) : 0, c9 = b5.slice(), i5;
  return function(t9) {
    for (i5 = 0; i5 < n6; ++i5) c9[i5] = a4[i5] * (1 - t9) + b5[i5] * t9;
    return c9;
  };
}
...
function genericArray(a4, b5) {
  var nb = b5 ? b5.length : 0, na = a4 ? Math.min(nb, a4.length) : 0, x4 = new Array(na), c9 = new Array(nb), i5;
  for (i5 = 0; i5 < na; ++i5) x4[i5] = value_default(a4[i5], b5[i5]);
  for (; i5 < nb; ++i5) c9[i5] = b5[i5];
  return function(t9) {
    for (i5 = 0; i5 < na; ++i5) c9[i5] = x4[i5](t9);
    return c9;
  };
}
...
function date_default(a4, b5) {
  ...
  return a4 = +a4, b5 = +b5, function(t9) {
    return d3.setTime(a4 * (1 - t9) + b5 * t9), d3;
  };
}
...
function object_default(a4, b5) {
  ...
  for (k5 in b5) {
    if (k5 in a4) {
      i5[k5] = value_default(a4[k5], b5[k5]);
    } else {
      c9[k5] = b5[k5];
    }
  }
  return function(t9) {
    for (k5 in i5) c9[k5] = i5[k5](t9);
    return c9;
  };
}
...
function string_default(a4, b5) {
  var bi = reA.lastIndex = reB.lastIndex = 0, am, bm, bs, i5 = -1, s4 = [], q2 = [];
  a4 = a4 + "", b5 = b5 + "";
  while ((am = reA.exec(a4)) && (bm = reB.exec(b5))) {
    ...
    if ((am = am[0]) === (bm = bm[0])) {
      ...
      s4[++i5] = null;
      q2.push({ i: i5, x: number_default(am, bm) });
    }
    bi = reB.lastIndex;
  }
  if (bi < b5.length) {
  ...
  return s4.length < 2 ? q2[0] ? one(q2[0].x) : zero(b5) : (b5 = q2.length, function(t9) {
    for (var i6 = 0, o4; i6 < b5; ++i6) s4[(o4 = q2[i6]).i] = o4.x(t9);
    return s4.join("");
  });
}
...
function round_default(a4, b5) {
  return a4 = +a4, b5 = +b5, function(t9) {
    return Math.round(a4 * (1 - t9) + b5 * t9);
  };
}
...
function decompose_default(a4, b5, c9, d3, e9, f3) {
...
function interpolateTransform(parse, pxComma, pxParen, degParen) {
  ...
  function translate(xa, ya, xb, yb, s4, q2) {
    if (xa !== xb || ya !== yb) {
      ...
      q2.push({ i: i5 - 4, x: number_default(xa, xb) }, { i: i5 - 2, x: number_default(ya, yb) });
    } else if (xb || yb) {
      s4.push("translate(" + xb + pxComma + yb + pxParen);
    }
  }
  function rotate(a4, b5, s4, q2) {
    if (a4 !== b5) {
      if (a4 - b5 > 180) b5 += 360;
      else if (b5 - a4 > 180) a4 += 360;
      q2.push({ i: s4.push(pop(s4) + "rotate(", null, degParen) - 2, x: number_default(a4, b5) });
    } else if (b5) {
      s4.push(pop(s4) + "rotate(" + b5 + degParen);
    }
  }
  function skewX(a4, b5, s4, q2) {
    if (a4 !== b5) {
      q2.push({ i: s4.push(pop(s4) + "skewX(", null, degParen) - 2, x: number_default(a4, b5) });
    } else if (b5) {
      s4.push(pop(s4) + "skewX(" + b5 + degParen);
    }
  }
  function scale2(xa, ya, xb, yb, s4, q2) {
    if (xa !== xb || ya !== yb) {
  ...
  return function(a4, b5) {
    ...
    translate(a4.translateX, a4.translateY, b5.translateX, b5.translateY, s4, q2);
    rotate(a4.rotate, b5.rotate, s4, q2);
    skewX(a4.skewX, b5.skewX, s4, q2);
    scale2(a4.scaleX, a4.scaleY, b5.scaleX, b5.scaleY, s4, q2);
    a4 = b5 = null;
    return function(t9) {
      var i5 = -1, n6 = q2.length, o4;
      while (++i5 < n6) s4[(o4 = q2[i5]).i] = o4.x(t9);
      return s4.join("");
    };
  };
}
...
var zoom_default = function zoomRho(rho, rho2, rho4) {
  function zoom(p0, p1) {
    ...
    if (d22 < epsilon2) {
      ...
      S3 = (r1 - r0) / rho;
      i5 = function(t9) {
        var s4 = t9 * S3, coshr0 = cosh(r0), u6 = w0 / (rho2 * d1) * (coshr0 * tanh(rho * s4 + r0) - sinh(r0));
        return [
          ux0 + u6 * dx,
          uy0 + u6 * dy,
...
function bisector(f3) {
  ...
  function center(a4, x4, lo = 0, hi = a4.length) {
    const i5 = left(a4, x4, lo, hi - 1);
    return i5 > lo && delta(a4[i5 - 1], x4) > -delta(a4[i5], x4) ? i5 - 1 : i5;
  }
...
function blurh(blur3, T4, S3, w5, h2) {
  for (let y4 = 0, n6 = w5 * h2; y4 < n6; ) {
    blur3(T4, S3, y4, y4 += w5, 1);
  }
}
function blurv(blur3, T4, S3, w5, h2) {
  for (let x4 = 0, n6 = w5 * h2; x4 < w5; ++x4) {
    blur3(T4, S3, x4, x4 + n6, w5);
  }
}
...
function blurf(radius) {
  ...
  return (T4, S3, start2, stop2, step) => {
    ...
    const s1 = s0 + step;
    for (let i5 = start2, j3 = start2 + s0; i5 < j3; i5 += step) {
      sum4 += S3[Math.min(stop2, i5)];
    }
    for (let i5 = start2, j3 = stop2; i5 <= j3; i5 += step) {
      sum4 += S3[Math.min(stop2, i5 + s0)];
      T4[i5] = (sum4 + t9 * (S3[Math.max(start2, i5 - s1)] + S3[Math.min(stop2, i5 + s1)])) / w5;
...
function bluri(radius) {
  ...
  return (T4, S3, start2, stop2, step) => {
    ...
    for (let i5 = start2, j3 = start2 + s4; i5 < j3; i5 += step) {
      sum4 += S3[Math.min(stop2, i5)];
    }
    for (let i5 = start2, j3 = stop2; i5 <= j3; i5 += step) {
      sum4 += S3[Math.min(stop2, i5 + s4)];
      T4[i5] = sum4 / w5;
      sum4 -= S3[Math.max(start2, i5 - s4)];
    }
  };
}
...
function polymap(domain, range2, interpolate2) {
  var j3 = Math.min(domain.length, range2.length) - 1, d3 = new Array(j3), r6 = new Array(j3), i5 = -1;
  ...
  while (++i5 < j3) {
    ...
    r6[i5] = interpolate2(range2[i5], range2[i5 + 1]);
  }
  return function(x4) {
    var i6 = bisect_default(domain, x4, 1, j3) - 1;
    return r6[i6](d3[i6](x4));
  };
}
...
function transformer() {
  ...
  return function(t9, u6) {
    transform = t9, untransform = u6;
    return rescale();
  };
}
function continuous() {
...
function formatDecimalParts(x4, p4) {
  if ((i5 = (x4 = p4 ? x4.toExponential(p4 - 1) : x4.toExponential()).indexOf("e")) < 0) return null;
  var i5, coefficient = x4.slice(0, i5);
  return [
...
function formatGroup_default(grouping, thousands) {
  return function(value, width) {
    var i5 = value.length, t9 = [], j3 = 0, g4 = grouping[0], length = 0;
    while (i5 > 0 && g4 > 0) {
      if (length + g4 + 1 > width) g4 = Math.max(1, width - length);
      t9.push(value.substring(i5 -= g4, i5 + g4));
...
function formatPrefixAuto_default(x4, p4) {
  ...
  return i5 === n6 ? coefficient : i5 > n6 ? coefficient + new Array(i5 - n6 + 1).join("0") : i5 > 0 ? coefficient.slice(0, i5) + "." + coefficient.slice(i5) : "0." + new Array(1 - i5).join("0") + formatDecimalParts(x4, Math.max(0, p4 + i5 - 1))[0];
}
...
function locale_default(locale3) {
  ...
  function formatPrefix2(specifier, value) {
    var f3 = newFormat((specifier = formatSpecifier(specifier), specifier.type = "f", specifier)), e9 = Math.max(-8, Math.min(8, Math.floor(exponent_default(value) / 3))) * 3, k5 = Math.pow(10, -e9), prefix2 = prefixes2[8 + e9 / 3];
...
function loggish(transform) {
  ...
  scale2.ticks = (count2) => {
    ...
    let z5 = [];
    if (!(base % 1) && j3 - i5 < n6) {
      i5 = Math.floor(i5), j3 = Math.ceil(j3);
      if (u6 > 0) for (; i5 <= j3; ++i5) {
        for (k5 = 1; k5 < base; ++k5) {
          t9 = i5 < 0 ? k5 / pows(-i5) : k5 * pows(i5);
          if (t9 < u6) continue;
          if (t9 > v6) break;
          z5.push(t9);
        }
      ...
      if (z5.length * 2 < n6) z5 = ticks(u6, v6, n6);
    } else {
      z5 = ticks(i5, j3, Math.min(j3 - i5, n6)).map(pows);
    }
...
function sinebow_default(t9) {
  var x4;
  t9 = (0.5 - t9) * Math.PI;
  c6.r = 255 * (x4 = Math.sin(t9)) * x4;
  c6.g = 255 * (x4 = Math.sin(t9 + pi_1_3)) * x4;
  c6.b = 255 * (x4 = Math.sin(t9 + pi_2_3)) * x4;
  return c6 + "";
}
...
var Path = class {
  ...
  arc(x4, y4, r6, a0, a1, ccw) {
    ...
    if (r6 < 0) throw new Error(`negative radius: ${r6}`);
    let dx = r6 * Math.cos(a0), dy = r6 * Math.sin(a0), x0 = x4 + dx, y0 = y4 + dy, cw = 1 ^ ccw, da2 = ccw ? a0 - a1 : a1 - a0;
    if (this._x1 === null) {
    ...
    if (da2 > tauEpsilon) {
      ...
      this._append`A${r6},${r6},0,${+(da2 >= pi2)},${cw},${this._x1 = x4 + r6 * Math.cos(a1)},${this._y1 = y4 + r6 * Math.sin(a1)}`;
    }
  }
  rect(x4, y4, w5, h2) {
...
function line_default(x4, y4) {
  ...
  function line(data) {
    var i5, n6 = (data = array_default2(data)).length, d3, defined0 = false, buffer;
    if (context == null) output = curve(buffer = path2());
    for (i5 = 0; i5 <= n6; ++i5) {
      if (!(i5 < n6 && defined(d3 = data[i5], i5, data)) === defined0) {
        if (defined0 = !defined0) output.lineStart();
        else output.lineEnd();
      }
      if (defined0) output.point(+x4(d3, i5, data), +y4(d3, i5, data));
    }
...
function area_default(x0, y0, y1) {
  ...
  function area(data) {
    var i5, j3, k5, n6 = (data = array_default2(data)).length, d3, defined0 = false, buffer, x0z = new Array(n6), y0z = new Array(n6);
    if (context == null) output = curve(buffer = path2());
    for (i5 = 0; i5 <= n6; ++i5) {
      if (!(i5 < n6 && defined(d3 = data[i5], i5, data)) === defined0) {
      ...
      if (defined0) {
        x0z[i5] = +x0(d3, i5, data), y0z[i5] = +y0(d3, i5, data);
        output.point(x1 ? +x1(d3, i5, data) : x0z[i5], y1 ? +y1(d3, i5, data) : y0z[i5]);
      }
    }
    if (buffer) return output = null, buffer + "" || null;
  }
...
Bundle.prototype = {
  ...
  lineEnd: function() {
    ...
    if (j3 > 0) {
      var x0 = x4[0], y0 = y4[0], dx = x4[j3] - x0, dy = y4[j3] - y0, i5 = -1, t9;
      while (++i5 <= j3) {
        t9 = i5 / j3;
        this._basis.point(
          this._beta * x4[i5] + (1 - this._beta) * (x0 + t9 * dx),
...
function point4(that, x4, y4) {
  ...
  if (that._l01_a > epsilon) {
    var a4 = 2 * that._l01_2a + 3 * that._l01_a * that._l12_a + that._l12_2a, n6 = 3 * that._l01_a * (that._l01_a + that._l12_a);
    x1 = (x1 * a4 - that._x0 * that._l12_2a + that._x2 * that._l01_2a) / n6;
    y1 = (y1 * a4 - that._y0 * that._l12_2a + that._y2 * that._l01_2a) / n6;
  }
...
Natural.prototype = {
  ...
  lineEnd: function() {
    var x4 = this._x, y4 = this._y, n6 = x4.length;
    if (n6) {
...
function controlPoints(x4) {
  var i5, n6 = x4.length - 1, m5, a4 = new Array(n6), b5 = new Array(n6), r6 = new Array(n6);
  a4[0] = 0, b5[0] = 2, r6[0] = x4[0] + 2 * x4[1];
  for (i5 = 1; i5 < n6 - 1; ++i5) a4[i5] = 1, b5[i5] = 4, r6[i5] = 4 * x4[i5] + 2 * x4[i5 + 1];
  a4[n6 - 1] = 2, b5[n6 - 1] = 7, r6[n6 - 1] = 8 * x4[n6 - 1] + x4[n6];
  for (i5 = 1; i5 < n6; ++i5) m5 = a4[i5] / b5[i5 - 1], b5[i5] -= m5, r6[i5] -= m5 * r6[i5 - 1];
  a4[n6 - 1] = r6[n6 - 1] / b5[n6 - 1];
  for (i5 = n6 - 2; i5 >= 0; --i5) a4[i5] = (r6[i5] - a4[i5 + 1]) / b5[i5];
  b5[n6 - 1] = (x4[n6] + a4[n6 - 1]) / 2;
  for (i5 = 0; i5 < n6 - 1; ++i5) b5[i5] = 2 * x4[i5 + 1] - a4[i5 + 1];
  return [a4, b5];
}
...
function none_default(series, order) {
  ...
  for (var i5 = 1, j3, s0, s1 = series[order[0]], n6, m5 = s1.length; i5 < n6; ++i5) {
...
function expand_default(series, order) {
  ...
  for (var i5, n6, j3 = 0, m5 = series[0].length, y4; j3 < m5; ++j3) {
    for (y4 = i5 = 0; i5 < n6; ++i5) y4 += series[i5][j3][1] || 0;
    if (y4) for (i5 = 0; i5 < n6; ++i5) series[i5][j3][1] /= y4;
  }
...
function diverging_default(series, order) {
  if (!((n6 = series.length) > 0)) return;
  for (var i5, j3 = 0, d3, dy, yp, yn3, n6, m5 = series[order[0]].length; j3 < m5; ++j3) {
    for (yp = yn3 = 0, i5 = 0; i5 < n6; ++i5) {
      if ((dy = (d3 = series[order[i5]][j3])[1] - d3[0]) > 0) {
        d3[0] = yp, d3[1] = yp += dy;
      } else if (dy < 0) {
...
function silhouette_default(series, order) {
  if (!((n6 = series.length) > 0)) return;
  for (var j3 = 0, s0 = series[order[0]], n6, m5 = s0.length; j3 < m5; ++j3) {
    for (var i5 = 0, y4 = 0; i5 < n6; ++i5) y4 += series[i5][j3][1] || 0;
...
function wiggle_default(series, order) {
  ...
  for (var y4 = 0, j3 = 1, s0, m5, n6; j3 < m5; ++j3) {
    for (var i5 = 0, s1 = 0, s22 = 0; i5 < n6; ++i5) {
      var si = series[order[i5]], sij0 = si[j3][1] || 0, sij1 = si[j3 - 1][1] || 0, s32 = (sij0 - sij1) / 2;
...
function peak(series) {
  var i5 = -1, j3 = 0, n6 = series.length, vi, vj = -Infinity;
  while (++i5 < n6) if ((vi = +series[i5][1]) > vj) vj = vi, j3 = i5;
  return j3;
}
...
function insideOut_default(series) {
  var n6 = series.length, i5, j3, sums = series.map(sum2), order = appearance_default(series), top = 0, bottom = 0, tops = [], bottoms = [];
  for (i5 = 0; i5 < n6; ++i5) {
    j3 = order[i5];
    if (top < bottom) {
      top += sums[j3];
...
function jr() {
  return jr = Object.assign ? Object.assign.bind() : function(e9) {
    for (var r6 = 1; r6 < arguments.length; r6++) {
      var t9 = arguments[r6];
      for (var n6 in t9) Object.prototype.hasOwnProperty.call(t9, n6) && (e9[n6] = t9[n6]);
    }
    return e9;
  }, jr.apply(this, arguments);
}
function Sr(e9, r6) {
  return Sr = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e11, r7) {
    return e11.__proto__ = r7, e11;
  }, Sr(e9, r6);
}
function Br(e9, r6) {
  if (null == e9) return {};
  var t9, n6, i5 = {}, o4 = Object.keys(e9);
  for (n6 = 0; n6 < o4.length; n6++) t9 = o4[n6], r6.indexOf(t9) >= 0 || (i5[t9] = e9[t9]);
  return i5;
}
...
var Lr = function(e9, r6) {
  return jr({}, r6, e9);
};
var Ir = function(e9, r6) {
  var t9 = (0, import_merge2.default)({}, e9, r6);
  return Gr.forEach(function(e11) {
    (0, import_set.default)(t9, e11, Lr((0, import_get.default)(t9, e11), t9.text));
  }), t9;
};
var Yr = (0, import_react15.createContext)();
var Ar = function(e9) {
  var t9 = e9.children, n6 = e9.animate, i5 = void 0 === n6 || n6, o4 = e9.config, l4 = void 0 === o4 ? "default" : o4, a4 = (0, import_react15.useMemo)(function() {
    var e11 = (0, import_isString.default)(l4) ? config[l4] : l4;
    return { animate: i5, config: e11 };
  }, [i5, l4]);
  return (0, import_jsx_runtime.jsx)(Yr.Provider, { value: a4, children: t9 });
};
...
var Fr = function(e9) {
  var t9 = Ur(), o4 = t9.animate, l4 = t9.config, a4 = function(e11) {
    var r6 = (0, import_react15.useRef)();
    return (0, import_react15.useEffect)(function() {
      r6.current = e11;
    }, [e11]), r6.current;
  }(e9), d3 = (0, import_react15.useMemo)(function() {
    return string_default(a4, e9);
  }, [a4, e9]), s4 = useSpring({ from: { value: 0 }, to: { value: 1 }, reset: true, config: l4, immediate: !o4 }).value;
  return to2(s4, d3);
};
...
var lt = function(e9) {
  if (!rt[e9]) throw new TypeError("'" + e9 + "', is not a valid curve interpolator identifier.");
  return rt[e9];
};
...
var wt = function(e9, t9, n6) {
  return void 0 === n6 && (n6 = {}), (0, import_react15.useMemo)(function() {
    var r6 = jr({}, _t, n6);
    return { margin: r6, innerWidth: e9 - r6.left - r6.right, innerHeight: t9 - r6.top - r6.bottom, outerWidth: e9, outerHeight: t9 };
  }, [e9, t9, n6.top, n6.right, n6.bottom, n6.left]);
};
var kt = function() {
  var e9 = (0, import_react15.useRef)(null), r6 = (0, import_react15.useState)({ left: 0, top: 0, width: 0, height: 0 }), t9 = r6[0], l4 = r6[1], a4 = (0, import_react15.useState)(function() {
  ...
  return (0, import_react15.useEffect)(function() {
    return e9.current && null !== a4 && a4.observe(e9.current), function() {
...
var Ct = {};
var Wt = function(e9) {
  var r6 = e9.theme, t9 = void 0 === r6 ? Ct : r6, n6 = e9.children, i5 = Rt(t9);
...
var Mt = function(e9) {
  return e9.outlineWidth, e9.outlineColor, e9.outlineOpacity, Br(e9, Tt);
};
var Pt = function(e9) {
  var r6 = e9.children, t9 = e9.condition, n6 = e9.wrapper;
  return t9 ? (0, import_react15.cloneElement)(n6, {}, r6) : r6;
};
...
var St = function(e9) {
  var r6 = e9.children, t9 = e9.theme, i5 = e9.renderWrapper, o4 = void 0 === i5 || i5, l4 = e9.isInteractive, a4 = void 0 === l4 || l4, d3 = e9.animate, s4 = e9.motionConfig, u6 = (0, import_react15.useRef)(null);
  return (0, import_jsx_runtime.jsx)(Wt, { theme: t9, children: (0, import_jsx_runtime.jsx)(Ar, { animate: d3, config: s4, children: (0, import_jsx_runtime.jsx)(M, { container: u6, children: (0, import_jsx_runtime.jsxs)(Pt, { condition: o4, wrapper: (0, import_jsx_runtime.jsx)("div", { style: jt, ref: u6 }), children: [r6, a4 && (0, import_jsx_runtime.jsx)(F, {})] }) }) }) });
};
...
var Lt = function(e9) {
  var t9 = e9.children, i5 = e9.theme, o4 = e9.isInteractive, l4 = void 0 === o4 || o4, d3 = e9.renderWrapper, s4 = void 0 === d3 || d3, u6 = e9.animate, c9 = e9.motionConfig, f3 = (0, import_react15.useRef)(null), m5 = V(f3), y4 = m5.actions, v6 = m5.state, _2 = (0, import_react15.useCallback)(function(e11, r6) {
    return y4.showTooltipFromEvent(e11, r6);
  }, [y4.showTooltipFromEvent]), w5 = (0, import_react15.useMemo)(function() {
    return { showTooltip: l4 ? _2 : Bt, hideTooltip: l4 ? y4.hideTooltip : Bt };
  }, [y4.hideTooltip, l4, _2]);
  return (0, import_jsx_runtime.jsx)(Wt, { theme: i5, children: (0, import_jsx_runtime.jsx)(Ar, { animate: u6, config: c9, children: (0, import_jsx_runtime.jsx)(j.Provider, { value: y4, children: (0, import_jsx_runtime.jsx)(O.Provider, { value: v6, children: (0, import_jsx_runtime.jsxs)(Pt, { condition: s4, wrapper: (0, import_jsx_runtime.jsx)("div", { style: Gt, ref: f3 }), children: [t9(w5), l4 && (0, import_jsx_runtime.jsx)(F, {})] }) }) }) }) });
};
...
var It = function(e9) {
  var r6 = e9.children, t9 = kt(), n6 = t9[0], i5 = t9[1], o4 = i5.width > 0 && i5.height > 0;
...
var Yt = ["id", "colors"];
var Dt = function(e9) {
  var r6 = e9.id, t9 = e9.colors, n6 = Br(e9, Yt);
  return (0, import_jsx_runtime.jsx)("linearGradient", jr({ id: r6, x1: 0, x2: 0, y1: 0, y2: 1 }, n6, { children: t9.map(function(e11) {
    var r7 = e11.offset, t10 = e11.color, n7 = e11.opacity;
    return (0, import_jsx_runtime.jsx)("stop", { offset: r7 + "%", stopColor: t10, stopOpacity: void 0 !== n7 ? n7 : 1 }, r7);
  }) }));
};
...
var Ft = (0, import_react15.memo)(function(e9) {
  var r6 = e9.id, t9 = e9.background, n6 = void 0 === t9 ? Ut.background : t9, i5 = e9.color, o4 = void 0 === i5 ? Ut.color : i5, l4 = e9.size, a4 = void 0 === l4 ? Ut.size : l4, d3 = e9.padding, s4 = void 0 === d3 ? Ut.padding : d3, u6 = e9.stagger, c9 = void 0 === u6 ? Ut.stagger : u6, f3 = a4 + s4, p4 = a4 / 2, h2 = s4 / 2;
...
var on = (0, import_react15.memo)(function(e9) {
  var r6 = e9.id, t9 = e9.spacing, n6 = void 0 === t9 ? nn.spacing : t9, i5 = e9.rotation, o4 = void 0 === i5 ? nn.rotation : i5, l4 = e9.background, a4 = void 0 === l4 ? nn.background : l4, d3 = e9.color, s4 = void 0 === d3 ? nn.color : d3, u6 = e9.lineWidth, c9 = void 0 === u6 ? nn.lineWidth : u6, f3 = Math.round(o4) % 360, p4 = Math.abs(n6);
  f3 > 180 ? f3 -= 360 : f3 > 90 ? f3 -= 180 : f3 < -180 ? f3 += 360 : f3 < -90 && (f3 += 180);
  var h2, g4 = p4, b5 = p4;
  return 0 === f3 ? h2 = "\n                M 0 0 L " + g4 + " 0\n                M 0 " + b5 + " L " + g4 + " " + b5 + "\n            " : 90 === f3 ? h2 = "\n                M 0 0 L 0 " + b5 + "\n                M " + g4 + " 0 L " + g4 + " " + b5 + "\n            " : (g4 = Math.abs(p4 / Math.sin(Ht(f3))), b5 = p4 / Math.sin(Ht(90 - f3)), h2 = f3 > 0 ? "\n                    M 0 " + -b5 + " L " + 2 * g4 + " " + b5 + "\n                    M " + -g4 + " " + -b5 + " L " + g4 + " " + b5 + "\n                    M " + -g4 + " 0 L " + g4 + " " + 2 * b5 + "\n                " : "\n                    M " + -g4 + " " + b5 + " L " + g4 + " " + -b5 + "\n                    M " + -g4 + " " + 2 * b5 + " L " + 2 * g4 + " " + -b5 + "\n                    M 0 " + 2 * b5 + " L " + 2 * g4 + " 0\n                "), (0, import_jsx_runtime.jsxs)("pattern", { id: r6, width: g4, height: b5, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime.jsx)("rect", { width: g4, height: b5, fill: a4, stroke: "rgba(255, 0, 0, 0.1)", strokeWidth: 0 }), (0, import_jsx_runtime.jsx)("path", { d: h2, strokeWidth: c9, stroke: s4, strokeLinecap: "square" })] });
});
...
var dn = (0, import_react15.memo)(function(e9) {
  var r6 = e9.id, t9 = e9.color, n6 = void 0 === t9 ? an.color : t9, i5 = e9.background, o4 = void 0 === i5 ? an.background : i5, l4 = e9.size, a4 = void 0 === l4 ? an.size : l4, d3 = e9.padding, s4 = void 0 === d3 ? an.padding : d3, u6 = e9.stagger, c9 = void 0 === u6 ? an.stagger : u6, f3 = a4 + s4, p4 = s4 / 2;
  return true === c9 && (f3 = 2 * a4 + 2 * s4), (0, import_jsx_runtime.jsxs)("pattern", { id: r6, width: f3, height: f3, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime.jsx)("rect", { width: f3, height: f3, fill: o4 }), (0, import_jsx_runtime.jsx)("rect", { x: p4, y: p4, width: a4, height: a4, fill: n6 }), c9 && (0, import_jsx_runtime.jsx)("rect", { x: 1.5 * s4 + a4, y: 1.5 * s4 + a4, width: a4, height: a4, fill: n6 })] });
});
...
var pn = function(e9) {
  var r6 = e9.defs;
  return !r6 || r6.length < 1 ? null : (0, import_jsx_runtime.jsx)("defs", { "aria-hidden": true, children: r6.map(function(e11) {
    var r7 = e11.type, t9 = Br(e11, cn);
    return fn[r7] ? (0, import_react15.createElement)(fn[r7], jr({ key: t9.id }, t9)) : null;
  }) });
};
...
var gn = function(e9) {
  var r6 = e9.width, t9 = e9.height, n6 = e9.margin, i5 = e9.defs, o4 = e9.children, l4 = e9.role, a4 = e9.ariaLabel, d3 = e9.ariaLabelledBy, s4 = e9.ariaDescribedBy, u6 = e9.isFocusable, c9 = zt();
  return (0, import_jsx_runtime.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: r6, height: t9, role: l4, "aria-label": a4, "aria-labelledby": d3, "aria-describedby": s4, focusable: u6, tabIndex: u6 ? 0 : void 0, children: [(0, import_jsx_runtime.jsx)(hn, { defs: i5 }), (0, import_jsx_runtime.jsx)("rect", { width: r6, height: t9, fill: c9.background }), (0, import_jsx_runtime.jsx)("g", { transform: "translate(" + n6.left + "," + n6.top + ")", children: o4 })] });
};
...
var bn = function(e9) {
  var r6 = e9.size, t9 = e9.color, n6 = e9.borderWidth, i5 = e9.borderColor;
  return (0, import_jsx_runtime.jsx)("circle", { r: r6 / 2, fill: t9, stroke: i5, strokeWidth: n6, style: { pointerEvents: "none" } });
};
...
var yn = function(e9) {
  var r6 = e9.x, t9 = e9.y, n6 = e9.symbol, i5 = void 0 === n6 ? mn : n6, o4 = e9.size, l4 = e9.datum, a4 = e9.color, d3 = e9.borderWidth, u6 = e9.borderColor, c9 = e9.label, f3 = e9.labelTextAnchor, p4 = void 0 === f3 ? "middle" : f3, h2 = e9.labelYOffset, g4 = void 0 === h2 ? -12 : h2, b5 = zt(), m5 = Ur(), y4 = m5.animate, v6 = m5.config, _2 = useSpring({ transform: "translate(" + r6 + ", " + t9 + ")", config: v6, immediate: !y4 });
  return (0, import_jsx_runtime.jsxs)(animated.g, { transform: _2.transform, style: { pointerEvents: "none" }, children: [(0, import_react15.createElement)(i5, { size: o4, color: a4, datum: l4, borderWidth: d3, borderColor: u6 }), c9 && (0, import_jsx_runtime.jsx)("text", { textAnchor: p4, y: g4, style: Mt(b5.dots.text), children: c9 })] });
};
...
var _n = function(e9) {
  var r6 = e9.width, t9 = e9.height, n6 = e9.axis, i5 = e9.scale, o4 = e9.value, l4 = e9.lineStyle, a4 = e9.textStyle, d3 = e9.legend, s4 = e9.legendNode, u6 = e9.legendPosition, c9 = void 0 === u6 ? "top-right" : u6, f3 = e9.legendOffsetX, p4 = void 0 === f3 ? 14 : f3, h2 = e9.legendOffsetY, g4 = void 0 === h2 ? 14 : h2, b5 = e9.legendOrientation, m5 = void 0 === b5 ? "horizontal" : b5, y4 = zt(), v6 = 0, _2 = 0, w5 = 0, k5 = 0;
  if ("y" === n6 ? (w5 = i5(o4), _2 = r6) : (v6 = i5(o4), k5 = t9), d3 && !s4) {
    var R = function(e11) {
      var r7 = e11.axis, t10 = e11.width, n7 = e11.height, i6 = e11.position, o5 = e11.offsetX, l5 = e11.offsetY, a5 = e11.orientation, d4 = 0, s5 = 0, u7 = "vertical" === a5 ? -90 : 0, c10 = "start";
      if ("x" === r7) switch (i6) {
        case "top-left":
          d4 = -o5, s5 = l5, c10 = "end";
          break;
        case "top":
          s5 = -l5, c10 = "horizontal" === a5 ? "middle" : "start";
          break;
        case "top-right":
          d4 = o5, s5 = l5, c10 = "horizontal" === a5 ? "start" : "end";
          break;
        case "right":
          d4 = o5, s5 = n7 / 2, c10 = "horizontal" === a5 ? "start" : "middle";
          break;
        case "bottom-right":
          d4 = o5, s5 = n7 - l5, c10 = "start";
          break;
        case "bottom":
          s5 = n7 + l5, c10 = "horizontal" === a5 ? "middle" : "end";
          break;
        case "bottom-left":
          s5 = n7 - l5, d4 = -o5, c10 = "horizontal" === a5 ? "end" : "start";
          break;
        case "left":
          d4 = -o5, s5 = n7 / 2, c10 = "horizontal" === a5 ? "end" : "middle";
      }
      else switch (i6) {
        case "top-left":
          d4 = o5, s5 = -l5, c10 = "start";
          break;
        case "top":
          d4 = t10 / 2, s5 = -l5, c10 = "horizontal" === a5 ? "middle" : "start";
          break;
        case "top-right":
          d4 = t10 - o5, s5 = -l5, c10 = "horizontal" === a5 ? "end" : "start";
          break;
        case "right":
          d4 = t10 + o5, c10 = "horizontal" === a5 ? "start" : "middle";
          break;
        case "bottom-right":
          d4 = t10 - o5, s5 = l5, c10 = "end";
          break;
        case "bottom":
          d4 = t10 / 2, s5 = l5, c10 = "horizontal" === a5 ? "middle" : "end";
          break;
        case "bottom-left":
          d4 = o5, s5 = l5, c10 = "horizontal" === a5 ? "start" : "end";
          break;
    ...
    }({ axis: n6, width: r6, height: t9, position: c9, offsetX: p4, offsetY: g4, orientation: m5 });
    s4 = (0, import_jsx_runtime.jsx)("text", { transform: "translate(" + R.x + ", " + R.y + ") rotate(" + R.rotation + ")", textAnchor: R.textAnchor, dominantBaseline: "central", style: a4, children: d3 });
  }
  return (0, import_jsx_runtime.jsxs)("g", { transform: "translate(" + v6 + ", " + w5 + ")", children: [(0, import_jsx_runtime.jsx)("line", { x1: 0, x2: _2, y1: 0, y2: k5, stroke: y4.markers.lineColor, strokeWidth: y4.markers.lineStrokeWidth, style: l4 }), s4] });
};
...
var kn = function(e9) {
  var r6 = e9.markers, t9 = e9.width, n6 = e9.height, i5 = e9.xScale, o4 = e9.yScale;
  return r6 && 0 !== r6.length ? r6.map(function(e11, r7) {
    return (0, import_jsx_runtime.jsx)(wn, jr({}, e11, { width: t9, height: n6, scale: "y" === e11.axis ? o4 : i5 }), r7);
  }) : null;
};
...
var On = function(e9) {
  return function(r6) {
    var t9, n6;
    function i5() {
      return r6.apply(this, arguments) || this;
    }
    return n6 = r6, (t9 = i5).prototype = Object.create(n6.prototype), t9.prototype.constructor = t9, Sr(t9, n6), i5.prototype.render = function() {
      var r7 = this.props, t10 = r7.theme, n7 = r7.renderWrapper, i6 = r7.animate, o4 = r7.motionConfig, l4 = Br(r7, xn);
      return (0, import_jsx_runtime.jsx)(St, { theme: t10, renderWrapper: n7, isInteractive: l4.isInteractive, animate: i6, motionConfig: o4, children: (0, import_jsx_runtime.jsx)(e9, jr({}, l4)) });
    }, i5;
  }(import_react15.Component);
};
var qn = function(e9, r6) {
  var t9, n6 = (0, import_isFunction.default)(e9) ? e9 : function(r7) {
    return (0, import_get.default)(r7, e9);
  };
  return r6 && (t9 = (0, import_isFunction.default)(r6) ? r6 : format(r6)), t9 ? function(e11) {
    return t9(n6(e11));
  } : n6;
};
var Cn = function(e9) {
  return (0, import_isFunction.default)(e9) ? e9 : function(r6) {
    return (0, import_get.default)(r6, e9);
  };
};
var Wn = function(e9) {
  return (0, import_react15.useMemo)(function() {
...
var Mn = function(e9, r6, t9, n6) {
  var i5 = t9 - e9, o4 = n6 - r6;
  return i5 *= i5, o4 *= o4, Math.sqrt(i5 + o4);
};
var jn = function(e9, r6, t9, n6, i5, o4) {
  return e9 <= i5 && i5 <= e9 + t9 && r6 <= o4 && o4 <= r6 + n6;
};
var Sn = function(e9, r6) {
  var t9, n6 = "touches" in r6 ? r6.touches[0] : r6, i5 = n6.clientX, o4 = n6.clientY, l4 = e9.getBoundingClientRect(), a4 = (t9 = void 0 !== e9.getBBox ? e9.getBBox() : { width: e9.offsetWidth || 0, height: e9.offsetHeight || 0 }).width === l4.width ? 1 : t9.width / l4.width;
  return [(i5 - l4.left) * a4, (o4 - l4.top) * a4];
};
var Bn = Object.keys(Et);
var Gn = Object.keys(un);
var Ln = function(e9, r6, t9) {
  if ("*" === e9) return true;
  if ((0, import_isFunction.default)(e9)) return e9(r6);
  if ((0, import_isPlainObject.default)(e9)) {
    var n6 = t9 ? (0, import_get.default)(r6, t9) : r6;
    return (0, import_isEqual.default)((0, import_pick.default)(n6, Object.keys(e9)), e9);
  }
  return false;
};
var In = function(e9, r6, t9, n6) {
  var i5 = void 0 === n6 ? {} : n6, o4 = i5.dataKey, l4 = i5.colorKey, a4 = void 0 === l4 ? "color" : l4, d3 = i5.targetKey, s4 = void 0 === d3 ? "fill" : d3, u6 = [], c9 = {};
  return e9.length && r6.length && (u6 = [].concat(e9), r6.forEach(function(r7) {
    for (var n7 = function() {
      var n8 = t9[i6], l5 = n8.id, d4 = n8.match;
      if (Ln(d4, r7, o4)) {
        var f3 = e9.find(function(e11) {
          return e11.id === l5;
        });
        if (f3) {
          if (Gn.includes(f3.type)) if ("inherit" === f3.background || "inherit" === f3.color) {
            var p4 = (0, import_get.default)(r7, a4), h2 = f3.background, g4 = f3.color, b5 = l5;
            "inherit" === f3.background && (b5 = b5 + ".bg." + p4, h2 = p4), "inherit" === f3.color && (b5 = b5 + ".fg." + p4, g4 = p4), (0, import_set.default)(r7, s4, "url(#" + b5 + ")"), c9[b5] || (u6.push(jr({}, f3, { id: b5, background: h2, color: g4 })), c9[b5] = 1);
          } else (0, import_set.default)(r7, s4, "url(#" + l5 + ")");
          else if (Bn.includes(f3.type)) {
            if (f3.colors.map(function(e11) {
              return e11.color;
            }).includes("inherit")) {
              var m5 = (0, import_get.default)(r7, a4), _2 = l5, w5 = jr({}, f3, { colors: f3.colors.map(function(e11, r8) {
                return "inherit" !== e11.color ? e11 : (_2 = _2 + "." + r8 + "." + m5, jr({}, e11, { color: "inherit" === e11.color ? m5 : e11.color }));
              }) });
              w5.id = _2, (0, import_set.default)(r7, s4, "url(#" + _2 + ")"), c9[_2] || (u6.push(w5), c9[_2] = 1);
            } else (0, import_set.default)(r7, s4, "url(#" + l5 + ")");
          }
        }
        return "break";
...
function v2() {
  return v2 = Object.assign ? Object.assign.bind() : function(t9) {
...
var m2 = function(t9, i5) {
  return "translate(" + t9 + "px, " + i5 + "px)";
};
var b = (0, import_react16.memo)(function(t9) {
  var o4, n6 = t9.position, r6 = t9.anchor, e9 = t9.children, l4 = zt(), d3 = Ur(), y4 = d3.animate, f3 = d3.config, b5 = kt(), g4 = b5[0], w5 = b5[1], T4 = (0, import_react16.useRef)(false), C6 = void 0, E4 = false, P4 = w5.width > 0 && w5.height > 0, j3 = Math.round(n6[0]), N2 = Math.round(n6[1]);
  P4 && ("top" === r6 ? (j3 -= w5.width / 2, N2 -= w5.height + 14) : "right" === r6 ? (j3 += 14, N2 -= w5.height / 2) : "bottom" === r6 ? (j3 -= w5.width / 2, N2 += 14) : "left" === r6 ? (j3 -= w5.width + 14, N2 -= w5.height / 2) : "center" === r6 && (j3 -= w5.width / 2, N2 -= w5.height / 2), C6 = { transform: m2(j3, N2) }, T4.current || (E4 = true), T4.current = [j3, N2]);
  var O5 = useSpring({ to: C6, config: f3, immediate: !y4 || E4 }), V2 = v2({}, x2, l4.tooltip.wrapper, { transform: null != (o4 = O5.transform) ? o4 : m2(j3, N2), opacity: O5.transform ? 1 : 0 });
  return (0, import_jsx_runtime2.jsx)(animated.div, { ref: g4, style: V2, children: e9 });
});
b.displayName = "TooltipWrapper";
var g = (0, import_react16.memo)(function(t9) {
  var i5 = t9.size, o4 = void 0 === i5 ? 12 : i5, n6 = t9.color, r6 = t9.style;
  return (0, import_jsx_runtime2.jsx)("span", { style: v2({ display: "block", width: o4, height: o4, background: n6 }, void 0 === r6 ? {} : r6) });
});
var w = (0, import_react16.memo)(function(t9) {
  var i5, o4 = t9.id, n6 = t9.value, r6 = t9.format, e9 = t9.enableChip, l4 = void 0 !== e9 && e9, a4 = t9.color, c9 = t9.renderContent, h2 = zt(), u6 = Ot(r6);
  if ("function" == typeof c9) i5 = c9();
  else {
    var f3 = n6;
    void 0 !== u6 && void 0 !== f3 && (f3 = u6(f3)), i5 = (0, import_jsx_runtime2.jsxs)("div", { style: h2.tooltip.basic, children: [l4 && (0, import_jsx_runtime2.jsx)(g, { color: a4, style: h2.tooltip.chip }), void 0 !== f3 ? (0, import_jsx_runtime2.jsxs)("span", { children: [o4, ": ", (0, import_jsx_runtime2.jsx)("strong", { children: "" + f3 })] }) : o4] });
  }
  return (0, import_jsx_runtime2.jsx)("div", { style: h2.tooltip.container, children: i5 });
});
var T = { width: "100%", borderCollapse: "collapse" };
var C3 = (0, import_react16.memo)(function(t9) {
  var i5, o4 = t9.title, n6 = t9.rows, r6 = void 0 === n6 ? [] : n6, e9 = t9.renderContent, l4 = zt();
  return r6.length ? (i5 = "function" == typeof e9 ? e9() : (0, import_jsx_runtime2.jsxs)("div", { children: [o4 && o4, (0, import_jsx_runtime2.jsx)("table", { style: v2({}, T, l4.tooltip.table), children: (0, import_jsx_runtime2.jsx)("tbody", { children: r6.map(function(t10, i6) {
    return (0, import_jsx_runtime2.jsx)("tr", { children: t10.map(function(t11, i7) {
      return (0, import_jsx_runtime2.jsx)("td", { style: l4.tooltip.tableCell, children: t11 }, i7);
    }) }, i6);
  }) }) })] }), (0, import_jsx_runtime2.jsx)("div", { style: l4.tooltip.container, children: i5 })) : null;
});
C3.displayName = "TableTooltip";
var E2 = (0, import_react16.memo)(function(t9) {
  var i5 = t9.x0, n6 = t9.x1, r6 = t9.y0, e9 = t9.y1, l4 = zt(), u6 = Ur(), d3 = u6.animate, y4 = u6.config, f3 = (0, import_react16.useMemo)(function() {
    return v2({}, l4.crosshair.line, { pointerEvents: "none" });
  }, [l4.crosshair.line]), x4 = useSpring({ x1: i5, x2: n6, y1: r6, y2: e9, config: y4, immediate: !d3 });
  return (0, import_jsx_runtime2.jsx)(animated.line, v2({}, x4, { fill: "none", style: f3 }));
});
E2.displayName = "CrosshairLine";
var P = (0, import_react16.memo)(function(t9) {
  var i5, o4, n6 = t9.width, r6 = t9.height, e9 = t9.type, l4 = t9.x, a4 = t9.y;
  return "cross" === e9 ? (i5 = { x0: l4, x1: l4, y0: 0, y1: r6 }, o4 = { x0: 0, x1: n6, y0: a4, y1: a4 }) : "top-left" === e9 ? (i5 = { x0: l4, x1: l4, y0: 0, y1: a4 }, o4 = { x0: 0, x1: l4, y0: a4, y1: a4 }) : "top" === e9 ? i5 = { x0: l4, x1: l4, y0: 0, y1: a4 } : "top-right" === e9 ? (i5 = { x0: l4, x1: l4, y0: 0, y1: a4 }, o4 = { x0: l4, x1: n6, y0: a4, y1: a4 }) : "right" === e9 ? o4 = { x0: l4, x1: n6, y0: a4, y1: a4 } : "bottom-right" === e9 ? (i5 = { x0: l4, x1: l4, y0: a4, y1: r6 }, o4 = { x0: l4, x1: n6, y0: a4, y1: a4 }) : "bottom" === e9 ? i5 = { x0: l4, x1: l4, y0: a4, y1: r6 } : "bottom-left" === e9 ? (i5 = { x0: l4, x1: l4, y0: a4, y1: r6 }, o4 = { x0: 0, x1: l4, y0: a4, y1: a4 }) : "left" === e9 ? o4 = { x0: 0, x1: l4, y0: a4, y1: a4 } : "x" === e9 ? i5 = { x0: l4, x1: l4, y0: 0, y1: r6 } : "y" === e9 && (o4 = { x0: 0, x1: n6, y0: a4, y1: a4 }), (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [i5 && (0, import_jsx_runtime2.jsx)(E2, { x0: i5.x0, x1: i5.x1, y0: i5.y0, y1: i5.y1 }), o4 && (0, import_jsx_runtime2.jsx)(E2, { x0: o4.x0, x1: o4.x1, y0: o4.y0, y1: o4.y1 })] });
});
...
var V = function(t9) {
  var i5 = (0, import_react16.useState)(N), n6 = i5[0], l4 = i5[1], a4 = (0, import_react16.useCallback)(function(t10, i6, o4) {
    var n7 = i6[0], r6 = i6[1];
    void 0 === o4 && (o4 = "top"), l4({ isVisible: true, position: [n7, r6], anchor: o4, content: t10 });
  }, [l4]), c9 = (0, import_react16.useCallback)(function(i6, o4, n7) {
    void 0 === n7 && (n7 = "top");
    var r6 = t9.current.getBoundingClientRect(), e9 = t9.current.offsetWidth, a5 = e9 === r6.width ? 1 : e9 / r6.width, c10 = "touches" in o4 ? o4.touches[0] : o4, s5 = c10.clientX, h2 = c10.clientY, u6 = (s5 - r6.left) * a5, d3 = (h2 - r6.top) * a5;
    "left" !== n7 && "right" !== n7 || (n7 = u6 < r6.width / 2 ? "right" : "left"), l4({ isVisible: true, position: [u6, d3], anchor: n7, content: i6 });
  }, [t9, l4]), s4 = (0, import_react16.useCallback)(function() {
    l4(N);
  }, [l4]);
...
var F = function() {
  var t9 = z2();
  return A2(t9) ? (0, import_jsx_runtime2.jsx)(b, { position: t9.position, anchor: t9.anchor, children: t9.content }) : null;
};
var M = function(t9) {
  var i5 = t9.container, o4 = t9.children, n6 = V(i5), r6 = n6.actions, e9 = n6.state;
  return (0, import_jsx_runtime2.jsx)(j.Provider, { value: r6, children: (0, import_jsx_runtime2.jsx)(O.Provider, { value: e9, children: o4 }) });
};
...
function qe() {
  return qe = Object.assign ? Object.assign.bind() : function(e9) {
    for (var r6 = 1; r6 < arguments.length; r6++) {
      var n6 = arguments[r6];
      for (var t9 in n6) Object.prototype.hasOwnProperty.call(n6, t9) && (e9[t9] = n6[t9]);
    }
    return e9;
...
function Ce(e9, r6) {
  ...
  for (var n6 = 0, t9 = new Array(r6); n6 < r6; n6++) t9[n6] = e9[n6];
  return t9;
}
function Ge(e9, r6) {
  var n6 = "undefined" != typeof Symbol && e9[Symbol.iterator] || e9["@@iterator"];
  if (n6) return (n6 = n6.call(e9)).next.bind(n6);
  if (Array.isArray(e9) || (n6 = function(e11, r7) {
    if (e11) {
      if ("string" == typeof e11) return Ce(e11, r7);
      var n7 = Object.prototype.toString.call(e11).slice(8, -1);
      return "Object" === n7 && e11.constructor && (n7 = e11.constructor.name), "Map" === n7 || "Set" === n7 ? Array.from(e11) : "Arguments" === n7 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n7) ? Ce(e11, r7) : void 0;
    }
  }(e9)) || r6 && e9 && "number" == typeof e9.length) {
    n6 && (e9 = n6);
    var t9 = 0;
    return function() {
      return t9 >= e9.length ? { done: true } : { done: false, value: e9[t9++] };
    };
  }
...
var We = function(e9, r6) {
  ...
  if ((0, import_isPlainObject2.default)(e9)) {
    if (function(e11) {
      ...
      var n6 = (0, import_get2.default)(r6, e9.theme);
      if (void 0 === n6) throw new Error("Color from theme is undefined at path: '" + e9.theme + "'");
      return function() {
        return n6;
      };
    }
    if (function(e11) {
      ...
      var t9 = function(r7) {
        return (0, import_get2.default)(r7, e9.from);
      };
      if (Array.isArray(e9.modifiers)) {
        for (var o4, i5 = [], u6 = function() {
          var e11 = o4.value, r7 = e11[0], n7 = e11[1];
          if ("brighter" === r7) i5.push(function(e12) {
            return e12.brighter(n7);
          });
          else if ("darker" === r7) i5.push(function(e12) {
            return e12.darker(n7);
          });
          else {
            if ("opacity" !== r7) throw new Error("Invalid color modifier: '" + r7 + "', must be one of: 'brighter', 'darker', 'opacity'");
            i5.push(function(e12) {
              return e12.opacity = n7, e12;
            });
          }
        }, a4 = Ge(e9.modifiers); !(o4 = a4()).done; ) u6();
        return 0 === i5.length ? t9 : function(e11) {
          return i5.reduce(function(e12, r7) {
            return r7(e12);
          }, rgb2(t9(e11))).toString();
        };
      }
      return t9;
    }
...
var fr = function(e9, r6) {
  if ("function" == typeof e9) return e9;
  var n6 = "function" == typeof r6 ? r6 : function(e11) {
    return (0, import_get2.default)(e11, r6);
  };
  if (Array.isArray(e9)) {
    var t9 = ordinal(e9), o4 = function(e11) {
      return t9(n6(e11));
    };
  ...
  if ((0, import_isPlainObject2.default)(e9)) {
    if (function(e11) {
      ...
      return (0, import_get2.default)(r7, e9.datum);
    };
    if (function(e11) {
      return void 0 !== e11.scheme;
    }(e9)) {
      if (He(e9.scheme)) {
        var i5 = ordinal(Be[e9.scheme]), u6 = function(e11) {
          return i5(n6(e11));
        };
        return u6.scale = i5, u6;
      }
      if (Je(e9.scheme)) {
        ...
        var a4 = ordinal(Be[e9.scheme][e9.size || 11]), l4 = function(e11) {
          return a4(n6(e11));
        };
      ...
      if (Ke(e9.scheme)) {
        ...
        var c9 = ordinal(Be[e9.scheme][e9.size || 9]), s4 = function(e11) {
          return c9(n6(e11));
        };
...
function $() {
  return $ = Object.assign ? Object.assign.bind() : function(n6) {
    for (var t9 = 1; t9 < arguments.length; t9++) {
      var r6 = arguments[t9];
      for (var e9 in r6) Object.prototype.hasOwnProperty.call(r6, e9) && (n6[e9] = r6[e9]);
    }
    return n6;
...
var Q = function(n6) {
  var t9 = n6.format, r6 = void 0 === t9 ? "native" : t9, e9 = n6.precision, a4 = void 0 === e9 ? "millisecond" : e9, u6 = n6.useUTC, c9 = void 0 === u6 || u6, s4 = L(a4);
  return function(n7) {
    if (void 0 === n7) return n7;
    if ("native" === r6 || n7 instanceof Date) return s4(n7);
    var t10 = c9 ? utcParse(r6) : timeParse(r6);
    return s4(t10(n7));
  };
};
var W2 = function(n6, t9, r6, e9) {
  var a4, i5, o4, c9, s4 = n6.min, d3 = void 0 === s4 ? 0 : s4, f3 = n6.max, l4 = void 0 === f3 ? "auto" : f3, m5 = n6.stacked, v6 = void 0 !== m5 && m5, y4 = n6.reverse, p4 = void 0 !== y4 && y4, h2 = n6.clamp, g4 = void 0 !== h2 && h2, x4 = n6.nice, k5 = void 0 !== x4 && x4;
  "auto" === d3 ? a4 = true === v6 ? null != (i5 = t9.minStacked) ? i5 : 0 : t9.min : a4 = d3;
  "auto" === l4 ? o4 = true === v6 ? null != (c9 = t9.maxStacked) ? c9 : 0 : t9.max : o4 = l4;
  var T4 = linear2().rangeRound("x" === e9 ? [0, r6] : [r6, 0]).domain(p4 ? [o4, a4] : [a4, o4]).clamp(g4);
  return true === k5 ? T4.nice() : "number" == typeof k5 && T4.nice(k5), X(T4, v6);
};
var X = function(n6, t9) {
  void 0 === t9 && (t9 = false);
  var r6 = n6;
  return r6.type = "linear", r6.stacked = t9, r6;
};
var Y = function(n6, t9, r6) {
  var e9 = point().range([0, r6]).domain(t9.all);
  return e9.type = "point", e9;
};
var _ = function(n6, t9, r6, e9) {
  var a4 = n6.round, i5 = void 0 === a4 || a4, o4 = band().range("x" === e9 ? [0, r6] : [r6, 0]).domain(t9.all).round(i5);
  return nn2(o4);
};
var nn2 = function(n6) {
  var t9 = n6;
...
var tn = function(n6, t9, r6) {
  var e9, a4, i5 = n6.format, o4 = void 0 === i5 ? "native" : i5, u6 = n6.precision, c9 = void 0 === u6 ? "millisecond" : u6, s4 = n6.min, l4 = void 0 === s4 ? "auto" : s4, m5 = n6.max, v6 = void 0 === m5 ? "auto" : m5, y4 = n6.useUTC, p4 = void 0 === y4 || y4, h2 = n6.nice, g4 = void 0 !== h2 && h2, x4 = Q({ format: o4, precision: c9, useUTC: p4 });
  e9 = "auto" === l4 ? x4(t9.min) : "native" !== o4 ? x4(l4) : l4, a4 = "auto" === v6 ? x4(t9.max) : "native" !== o4 ? x4(v6) : v6;
  var k5 = p4 ? utcTime() : time();
  k5.range([0, r6]), e9 && a4 && k5.domain([e9, a4]), true === g4 ? k5.nice() : "object" != typeof g4 && "number" != typeof g4 || k5.nice(g4);
  var T4 = k5;
  return T4.type = "time", T4.useUTC = p4, T4;
};
var rn2 = function(n6, t9, r6, e9) {
  var a4, i5 = n6.base, o4 = void 0 === i5 ? 10 : i5, u6 = n6.min, c9 = void 0 === u6 ? "auto" : u6, s4 = n6.max, d3 = void 0 === s4 ? "auto" : s4;
  ...
  if (t9.all.filter(function(n7) {
    ...
    v6 || (void 0 === a4 ? a4 = Math.sign(n7) : Math.sign(n7) !== a4 && (v6 = true));
  ...
  var y4 = log().domain([f3, m5]).rangeRound("x" === e9 ? [0, r6] : [r6, 0]).base(o4).nice();
  return y4.type = "log", y4;
};
var en = function(n6, t9, r6, e9) {
  var a4, i5, o4 = n6.constant, u6 = void 0 === o4 ? 1 : o4, c9 = n6.min, s4 = void 0 === c9 ? "auto" : c9, d3 = n6.max, f3 = void 0 === d3 ? "auto" : d3, l4 = n6.reverse, v6 = void 0 !== l4 && l4;
  a4 = "auto" === s4 ? t9.min : s4, i5 = "auto" === f3 ? t9.max : f3;
  var y4 = symlog().constant(u6).rangeRound("x" === e9 ? [0, r6] : [r6, 0]).nice();
  true === v6 ? y4.domain([i5, a4]) : y4.domain([a4, i5]);
  var p4 = y4;
...
var on2 = function(n6, t9) {
  return n6 === t9;
};
var un2 = function(n6, t9) {
  return n6.getTime() === t9.getTime();
};
function cn2(n6, t9, r6, e9) {
  switch (n6.type) {
    case "linear":
      return W2(n6, t9, r6, e9);
    case "point":
      return Y(n6, t9, r6);
    case "band":
      return _(n6, t9, r6, e9);
    case "time":
      return tn(n6, t9, r6);
    case "log":
      return rn2(n6, t9, r6, e9);
    case "symlog":
      return en(n6, t9, r6, e9);
    default:
      throw new Error("invalid scale spec");
  }
}
var sn = function(n6, t9, r6) {
  var e9;
  if ("stacked" in r6 && r6.stacked) {
    var a4 = n6.data["x" === t9 ? "xStacked" : "yStacked"];
    return null == a4 ? null : r6(a4);
  }
  return null != (e9 = r6(n6.data[t9])) ? e9 : null;
};
var dn2 = function(n6, t9, r6, e9, a4) {
  ...
  "stacked" in t9 && true === t9.stacked && vn2(o4, i5), "stacked" in r6 && true === r6.stacked && yn2(o4, i5);
  var u6 = cn2(t9, o4.x, e9, "x"), c9 = cn2(r6, o4.y, a4, "y"), s4 = i5.map(function(n7) {
    return $({}, n7, { data: n7.data.map(function(n8) {
      return $({}, n8, { position: { x: sn(n8, "x", u6), y: sn(n8, "y", c9) } });
    }) });
  });
  return $({}, o4, { series: s4, xScale: u6, yScale: c9 });
};
var fn2 = function(n6, t9, r6) {
  return { x: ln(n6, "x", t9), y: ln(n6, "y", r6) };
};
var ln = function(a4, i5, o4, u6) {
  var c9 = void 0 === u6 ? {} : u6, s4 = c9.getValue, d3 = void 0 === s4 ? function(n6) {
    return n6.data[i5];
  } : s4, f3 = c9.setValue, l4 = void 0 === f3 ? function(n6, t9) {
    n6.data[i5] = t9;
  } : f3;
  if ("linear" === o4.type) a4.forEach(function(n6) {
    n6.data.forEach(function(n7) {
      var t9 = d3(n7);
      t9 && l4(n7, parseFloat(String(t9)));
    });
  });
  ...
  switch (a4.forEach(function(n6) {
    ...
    case "linear":
      var y4 = (0, import_sortBy.default)((0, import_uniq.default)(v6).filter(function(n6) {
        return null !== n6;
      }), function(n6) {
        return n6;
      });
    ...
    case "time":
      var p4 = (0, import_uniqBy.default)(v6, function(n6) {
        return n6.getTime();
...
var mn2 = function(n6, t9, r6) {
  var i5 = an2(n6), o4 = [];
  t9[i5].all.forEach(function(t10) {
    var u6 = (0, import_isDate.default)(t10) ? un2 : on2, c9 = [];
    r6.forEach(function(r7) {
      var a4 = r7.data.find(function(n7) {
        return u6(n7.data[i5], t10);
      }), s4 = null, d3 = null;
      if (void 0 !== a4) {
        if (null !== (s4 = a4.data[n6])) {
          var f3 = (0, import_last2.default)(c9);
          void 0 === f3 ? d3 = s4 : null !== f3 && (d3 = f3 + s4);
        }
        a4.data["x" === n6 ? "xStacked" : "yStacked"] = d3;
      }
      c9.push(d3), null !== d3 && o4.push(d3);
    });
  }), t9[n6].minStacked = Math.min.apply(Math, o4), t9[n6].maxStacked = Math.max.apply(Math, o4);
};
var vn2 = function(n6, t9) {
  return mn2("x", n6, t9);
};
var yn2 = function(n6, t9) {
  return mn2("y", n6, t9);
};
var pn2 = function(n6) {
  var t9 = n6.bandwidth();
  if (0 === t9) return n6;
  var r6 = t9 / 2;
  return n6.round() && (r6 = Math.round(r6)), function(t10) {
    var e9;
    return (null != (e9 = n6(t10)) ? e9 : 0) + r6;
  };
};
...
var kn2 = function(n6, t9) {
  ...
  if ("string" == typeof t9 && "useUTC" in n6) {
    var r6 = t9.match(xn2);
    if (r6) {
      var e9 = r6[1], a4 = r6[2], i5 = hn2[a4][n6.useUTC ? 1 : 0];
      if ("day" === a4) {
        var o4, u6, c9 = n6.domain(), s4 = c9[0], d3 = c9[1], f3 = new Date(d3);
        return f3.setDate(f3.getDate() + 1), null != (o4 = null == (u6 = i5.every(Number(null != e9 ? e9 : 1))) ? void 0 : u6.range(s4, f3)) ? o4 : [];
      }
      if (void 0 === e9) return n6.ticks(i5);
      var l4 = i5.every(Number(e9));
...
var b2 = function(t9) {
  var e9, i5 = t9.axis, n6 = t9.scale, r6 = t9.ticksPosition, o4 = t9.tickValues, l4 = t9.tickSize, s4 = t9.tickPadding, c9 = t9.tickRotation, f3 = t9.truncateTickAt, u6 = t9.engine, d3 = void 0 === u6 ? "svg" : u6, x4 = kn2(n6, o4), m5 = rn[d3], k5 = "bandwidth" in n6 ? pn2(n6) : n6, g4 = { lineX: 0, lineY: 0 }, v6 = { textX: 0, textY: 0 }, b5 = "object" == typeof document && "rtl" === document.dir, P4 = m5.align.center, T4 = m5.baseline.center;
  "x" === i5 ? (e9 = function(t10) {
    var e11;
    return { x: null != (e11 = k5(t10)) ? e11 : 0, y: 0 };
  }, g4.lineY = l4 * ("after" === r6 ? 1 : -1), v6.textY = (l4 + s4) * ("after" === r6 ? 1 : -1), T4 = "after" === r6 ? m5.baseline.top : m5.baseline.bottom, 0 === c9 ? P4 = m5.align.center : "after" === r6 && c9 < 0 || "before" === r6 && c9 > 0 ? (P4 = m5.align[b5 ? "left" : "right"], T4 = m5.baseline.center) : ("after" === r6 && c9 > 0 || "before" === r6 && c9 < 0) && (P4 = m5.align[b5 ? "right" : "left"], T4 = m5.baseline.center)) : (e9 = function(t10) {
    var e11;
    return { x: 0, y: null != (e11 = k5(t10)) ? e11 : 0 };
  }, g4.lineX = l4 * ("after" === r6 ? 1 : -1), v6.textX = (l4 + s4) * ("after" === r6 ? 1 : -1), P4 = "after" === r6 ? m5.align.left : m5.align.right);
  return { ticks: x4.map(function(t10) {
    var i6 = "string" == typeof t10 ? function(t11) {
      var e11 = String(t11).length;
      return f3 && f3 > 0 && e11 > f3 ? "" + String(t11).slice(0, f3).concat("...") : "" + t11;
    }(t10) : t10;
    return p2({ key: t10 instanceof Date ? "" + t10.valueOf() : "" + t10, value: i6 }, e9(t10), g4, v6);
  }), textAlign: P4, textBaseline: T4 };
};
var P2 = function(t9, e9) {
...
var T2 = function(t9) {
  var e9, i5 = t9.width, n6 = t9.height, r6 = t9.scale, a4 = t9.axis, o4 = t9.values, l4 = (e9 = o4, Array.isArray(e9) ? o4 : void 0) || kn2(r6, o4), s4 = "bandwidth" in r6 ? pn2(r6) : r6, c9 = "x" === a4 ? l4.map(function(t10) {
    var e11, i6;
    return { key: t10 instanceof Date ? "" + t10.valueOf() : "" + t10, x1: null != (e11 = s4(t10)) ? e11 : 0, x2: null != (i6 = s4(t10)) ? i6 : 0, y1: 0, y2: n6 };
  }) : l4.map(function(t10) {
    var e11, n7;
    return { key: t10 instanceof Date ? "" + t10.valueOf() : "" + t10, x1: 0, x2: i5, y1: null != (e11 = s4(t10)) ? e11 : 0, y2: null != (n7 = s4(t10)) ? n7 : 0 };
  });
  return c9;
};
var A3 = (0, import_react18.memo)(function(t9) {
  var e9, n6 = t9.value, r6 = t9.format, a4 = t9.lineX, s4 = t9.lineY, c9 = t9.onClick, u6 = t9.textBaseline, d3 = t9.textAnchor, x4 = t9.animatedProps, m5 = zt(), y4 = m5.axis.ticks.line, h2 = m5.axis.ticks.text, v6 = null != (e9 = null == r6 ? void 0 : r6(n6)) ? e9 : n6, b5 = (0, import_react18.useMemo)(function() {
    var t10 = { opacity: x4.opacity };
    return c9 ? { style: p2({}, t10, { cursor: "pointer" }), onClick: function(t11) {
      return c9(t11, v6);
    } } : { style: t10 };
  }, [x4.opacity, c9, v6]);
  return (0, import_jsx_runtime3.jsxs)(animated.g, p2({ transform: x4.transform }, b5, { children: [(0, import_jsx_runtime3.jsx)("line", { x1: 0, x2: a4, y1: 0, y2: s4, style: y4 }), h2.outlineWidth > 0 && (0, import_jsx_runtime3.jsx)(animated.text, { dominantBaseline: u6, textAnchor: d3, transform: x4.textTransform, style: h2, strokeWidth: 2 * h2.outlineWidth, stroke: h2.outlineColor, strokeLinejoin: "round", children: "" + v6 }), (0, import_jsx_runtime3.jsx)(animated.text, { dominantBaseline: u6, textAnchor: d3, transform: x4.textTransform, style: Mt(h2), children: "" + v6 })] }));
});
var S = function(e9) {
  var r6 = e9.axis, a4 = e9.scale, l4 = e9.x, c9 = void 0 === l4 ? 0 : l4, x4 = e9.y, m5 = void 0 === x4 ? 0 : x4, y4 = e9.length, h2 = e9.ticksPosition, T4 = e9.tickValues, S3 = e9.tickSize, W5 = void 0 === S3 ? 5 : S3, w5 = e9.tickPadding, B5 = void 0 === w5 ? 5 : w5, X4 = e9.tickRotation, Y4 = void 0 === X4 ? 0 : X4, C6 = e9.format, O5 = e9.renderTick, j3 = void 0 === O5 ? A3 : O5, z5 = e9.truncateTickAt, V2 = e9.legend, D4 = e9.legendPosition, R = void 0 === D4 ? "end" : D4, E4 = e9.legendOffset, q2 = void 0 === E4 ? 0 : E4, F2 = e9.onClick, L3 = e9.ariaHidden, N2 = zt(), H3 = N2.axis.legend.text, I2 = (0, import_react18.useMemo)(function() {
    return P2(C6, a4);
  }, [C6, a4]), J2 = b2({ axis: r6, scale: a4, ticksPosition: h2, tickValues: T4, tickSize: W5, tickPadding: B5, tickRotation: Y4, truncateTickAt: z5 }), G = J2.ticks, K3 = J2.textAlign, M3 = J2.textBaseline, Q2 = null;
  if (void 0 !== V2) {
    var U, Z = 0, $2 = 0, _2 = 0;
    "y" === r6 ? (_2 = -90, Z = q2, "start" === R ? (U = "start", $2 = y4) : "middle" === R ? (U = "middle", $2 = y4 / 2) : "end" === R && (U = "end")) : ($2 = q2, "start" === R ? U = "start" : "middle" === R ? (U = "middle", Z = y4 / 2) : "end" === R && (U = "end", Z = y4)), Q2 = (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [H3.outlineWidth > 0 && (0, import_jsx_runtime3.jsx)("text", { transform: "translate(" + Z + ", " + $2 + ") rotate(" + _2 + ")", textAnchor: U, style: p2({ dominantBaseline: "central" }, H3), strokeWidth: 2 * H3.outlineWidth, stroke: H3.outlineColor, strokeLinejoin: "round", children: V2 }), (0, import_jsx_runtime3.jsx)("text", { transform: "translate(" + Z + ", " + $2 + ") rotate(" + _2 + ")", textAnchor: U, style: p2({ dominantBaseline: "central" }, H3), children: V2 })] });
  }
  var tt2 = Ur(), et2 = tt2.animate, it2 = tt2.config, nt2 = useSpring({ transform: "translate(" + c9 + "," + m5 + ")", lineX2: "x" === r6 ? y4 : 0, lineY2: "x" === r6 ? 0 : y4, config: it2, immediate: !et2 }), rt2 = (0, import_react18.useCallback)(function(t9) {
    return { opacity: 1, transform: "translate(" + t9.x + "," + t9.y + ")", textTransform: "translate(" + t9.textX + "," + t9.textY + ") rotate(" + Y4 + ")" };
  }, [Y4]), at2 = (0, import_react18.useCallback)(function(t9) {
  ...
  return (0, import_jsx_runtime3.jsxs)(animated.g, { transform: nt2.transform, "aria-hidden": L3, children: [ot2(function(e11, i5, n6, r7) {
    return t6.createElement(j3, p2({ tickIndex: r7, format: I2, rotate: Y4, textBaseline: M3, textAnchor: K3, truncateTickAt: z5, animatedProps: e11 }, i5, F2 ? { onClick: F2 } : {}));
...
var B2 = (0, import_react18.memo)(function(t9) {
  var e9 = t9.xScale, i5 = t9.yScale, n6 = t9.width, r6 = t9.height, a4 = { top: t9.top, right: t9.right, bottom: t9.bottom, left: t9.left };
  return (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: w2.map(function(t10) {
    var o4 = a4[t10];
    if (!o4) return null;
    var l4 = "top" === t10 || "bottom" === t10;
    return (0, import_jsx_runtime3.jsx)(W3, p2({}, o4, { axis: l4 ? "x" : "y", x: "right" === t10 ? n6 : 0, y: "bottom" === t10 ? r6 : 0, scale: l4 ? e9 : i5, length: l4 ? n6 : r6, ticksPosition: "top" === t10 || "left" === t10 ? "before" : "after", truncateTickAt: o4.truncateTickAt }), t10);
  }) });
});
var X2 = (0, import_react18.memo)(function(t9) {
  var e9 = t9.animatedProps, i5 = zt();
  return (0, import_jsx_runtime3.jsx)(animated.line, p2({}, e9, i5.grid.line));
});
var Y2 = (0, import_react18.memo)(function(t9) {
  var e9 = t9.lines, i5 = Ur(), n6 = i5.animate, a4 = i5.config, o4 = useTransition(e9, { keys: function(t10) {
    return t10.key;
  ...
  return (0, import_jsx_runtime3.jsx)("g", { children: o4(function(t10, e11) {
    return (0, import_react18.createElement)(X2, p2({}, e11, { key: e11.key, animatedProps: t10 }));
  }) });
});
var C4 = (0, import_react18.memo)(function(t9) {
  var e9 = t9.width, n6 = t9.height, r6 = t9.xScale, a4 = t9.yScale, o4 = t9.xValues, l4 = t9.yValues, s4 = (0, import_react18.useMemo)(function() {
    return !!r6 && T2({ width: e9, height: n6, scale: r6, axis: "x", values: o4 });
  }, [r6, o4, e9, n6]), c9 = (0, import_react18.useMemo)(function() {
    return !!a4 && T2({ width: e9, height: n6, scale: a4, axis: "y", values: l4 });
  }, [n6, e9, a4, l4]);
...
var O3 = function(t9, e9) {
  var i5, n6 = e9.axis, r6 = e9.scale, a4 = e9.x, o4 = void 0 === a4 ? 0 : a4, l4 = e9.y, s4 = void 0 === l4 ? 0 : l4, f3 = e9.length, u6 = e9.ticksPosition, d3 = e9.tickValues, x4 = e9.tickSize, m5 = void 0 === x4 ? 5 : x4, y4 = e9.tickPadding, h2 = void 0 === y4 ? 5 : y4, k5 = e9.tickRotation, g4 = void 0 === k5 ? 0 : k5, v6 = e9.format, p4 = e9.legend, P4 = e9.legendPosition, T4 = void 0 === P4 ? "end" : P4, A4 = e9.legendOffset, S3 = void 0 === A4 ? 0 : A4, W5 = e9.theme, w5 = b2({ axis: n6, scale: r6, ticksPosition: u6, tickValues: d3, tickSize: m5, tickPadding: h2, tickRotation: g4, engine: "canvas" }), B5 = w5.ticks, X4 = w5.textAlign, Y4 = w5.textBaseline;
  t9.save(), t9.translate(o4, s4), t9.textAlign = X4, t9.textBaseline = Y4;
  var C6 = W5.axis.ticks.text;
  t9.font = (C6.fontWeight ? C6.fontWeight + " " : "") + C6.fontSize + "px " + C6.fontFamily, (null != (i5 = W5.axis.domain.line.strokeWidth) ? i5 : 0) > 0 && (t9.lineWidth = Number(W5.axis.domain.line.strokeWidth), t9.lineCap = "square", W5.axis.domain.line.stroke && (t9.strokeStyle = W5.axis.domain.line.stroke), t9.beginPath(), t9.moveTo(0, 0), t9.lineTo("x" === n6 ? f3 : 0, "x" === n6 ? 0 : f3), t9.stroke());
  var O5 = "function" == typeof v6 ? v6 : function(t10) {
    return "" + t10;
  };
  if (B5.forEach(function(e11) {
    var i6;
    (null != (i6 = W5.axis.ticks.line.strokeWidth) ? i6 : 0) > 0 && (t9.lineWidth = Number(W5.axis.ticks.line.strokeWidth), t9.lineCap = "square", W5.axis.ticks.line.stroke && (t9.strokeStyle = W5.axis.ticks.line.stroke), t9.beginPath(), t9.moveTo(e11.x, e11.y), t9.lineTo(e11.x + e11.lineX, e11.y + e11.lineY), t9.stroke());
    var n7 = O5(e11.value);
    t9.save(), t9.translate(e11.x + e11.textX, e11.y + e11.textY), t9.rotate(Ht(g4)), C6.outlineWidth > 0 && (t9.strokeStyle = C6.outlineColor, t9.lineWidth = 2 * C6.outlineWidth, t9.lineJoin = "round", t9.strokeText("" + n7, 0, 0)), W5.axis.ticks.text.fill && (t9.fillStyle = C6.fill), t9.fillText("" + n7, 0, 0), t9.restore();
  }), void 0 !== p4) {
    var j3 = 0, z5 = 0, V2 = 0, D4 = "center";
    "y" === n6 ? (V2 = -90, j3 = S3, "start" === T4 ? (D4 = "start", z5 = f3) : "middle" === T4 ? (D4 = "center", z5 = f3 / 2) : "end" === T4 && (D4 = "end")) : (z5 = S3, "start" === T4 ? D4 = "start" : "middle" === T4 ? (D4 = "center", j3 = f3 / 2) : "end" === T4 && (D4 = "end", j3 = f3)), t9.translate(j3, z5), t9.rotate(Ht(V2)), t9.font = (W5.axis.legend.text.fontWeight ? W5.axis.legend.text.fontWeight + " " : "") + W5.axis.legend.text.fontSize + "px " + W5.axis.legend.text.fontFamily, W5.axis.legend.text.fill && (t9.fillStyle = W5.axis.legend.text.fill), t9.textAlign = D4, t9.textBaseline = "middle", t9.fillText(p4, 0, 0);
  }
  t9.restore();
};
var j2 = function(t9, e9) {
  var i5 = e9.xScale, n6 = e9.yScale, r6 = e9.width, a4 = e9.height, o4 = e9.top, l4 = e9.right, s4 = e9.bottom, c9 = e9.left, f3 = e9.theme, u6 = { top: o4, right: l4, bottom: s4, left: c9 };
  w2.forEach(function(e11) {
    var o5 = u6[e11];
    if (!o5) return null;
    var l5 = "top" === e11 || "bottom" === e11, s5 = "top" === e11 || "left" === e11 ? "before" : "after", c10 = l5 ? i5 : n6, d3 = P2(o5.format, c10);
    O3(t9, p2({}, o5, { axis: l5 ? "x" : "y", x: "right" === e11 ? r6 : 0, y: "bottom" === e11 ? a4 : 0, scale: c10, format: d3, length: l5 ? r6 : a4, ticksPosition: s5, theme: f3 }));
  });
};
var z3 = function(t9, e9) {
  var i5 = e9.width, n6 = e9.height, r6 = e9.scale, a4 = e9.axis, o4 = e9.values;
  T2({ width: i5, height: n6, scale: r6, axis: a4, values: o4 }).forEach(function(e11) {
    t9.beginPath(), t9.moveTo(e11.x1, e11.y1), t9.lineTo(e11.x2, e11.y2), t9.stroke();
  });
};
...
var f2 = function(e9) {
  var i5 = e9.x, n6 = e9.y, o4 = e9.size, r6 = e9.fill, l4 = e9.opacity, a4 = void 0 === l4 ? 1 : l4, c9 = e9.borderWidth, d3 = void 0 === c9 ? 0 : c9, s4 = e9.borderColor;
  return (0, import_jsx_runtime4.jsx)("circle", { r: o4 / 2, cx: i5 + o4 / 2, cy: n6 + o4 / 2, fill: r6, opacity: a4, strokeWidth: d3, stroke: void 0 === s4 ? "transparent" : s4, style: { pointerEvents: "none" } });
};
var m3 = function(e9) {
  var i5 = e9.x, n6 = e9.y, o4 = e9.size, r6 = e9.fill, l4 = e9.opacity, a4 = void 0 === l4 ? 1 : l4, c9 = e9.borderWidth, d3 = void 0 === c9 ? 0 : c9, s4 = e9.borderColor;
  return (0, import_jsx_runtime4.jsx)("g", { transform: "translate(" + i5 + "," + n6 + ")", children: (0, import_jsx_runtime4.jsx)("path", { d: "\n                    M" + o4 / 2 + " 0\n                    L" + 0.8 * o4 + " " + o4 / 2 + "\n                    L" + o4 / 2 + " " + o4 + "\n                    L" + 0.2 * o4 + " " + o4 / 2 + "\n                    L" + o4 / 2 + " 0\n                ", fill: r6, opacity: a4, strokeWidth: d3, stroke: void 0 === s4 ? "transparent" : s4, style: { pointerEvents: "none" } }) });
};
var v4 = function(e9) {
  var i5 = e9.x, n6 = e9.y, o4 = e9.size, r6 = e9.fill, l4 = e9.opacity, a4 = void 0 === l4 ? 1 : l4, c9 = e9.borderWidth, d3 = void 0 === c9 ? 0 : c9, s4 = e9.borderColor;
  return (0, import_jsx_runtime4.jsx)("rect", { x: i5, y: n6, fill: r6, opacity: a4, strokeWidth: d3, stroke: void 0 === s4 ? "transparent" : s4, width: o4, height: o4, style: { pointerEvents: "none" } });
};
var u2 = function(e9) {
  var i5 = e9.x, n6 = e9.y, o4 = e9.size, r6 = e9.fill, l4 = e9.opacity, a4 = void 0 === l4 ? 1 : l4, c9 = e9.borderWidth, d3 = void 0 === c9 ? 0 : c9, s4 = e9.borderColor;
  return (0, import_jsx_runtime4.jsx)("g", { transform: "translate(" + i5 + "," + n6 + ")", children: (0, import_jsx_runtime4.jsx)("path", { d: "\n                M" + o4 / 2 + " 0\n                L" + o4 + " " + o4 + "\n                L0 " + o4 + "\n                L" + o4 / 2 + " 0\n            ", fill: r6, opacity: a4, strokeWidth: d3, stroke: void 0 === s4 ? "transparent" : s4, style: { pointerEvents: "none" } }) });
...
function p3() {
  return p3 = Object.assign ? Object.assign.bind() : function(t9) {
    for (var e9 = 1; e9 < arguments.length; e9++) {
      var i5 = arguments[e9];
      for (var n6 in i5) Object.prototype.hasOwnProperty.call(i5, n6) && (t9[n6] = i5[n6]);
    }
...
var x3 = function(t9) {
  var e9, i5 = t9.direction, n6 = t9.itemsSpacing, o4 = t9.padding, r6 = t9.itemCount, l4 = t9.itemWidth, a4 = t9.itemHeight;
  if ("number" != typeof o4 && ("object" != typeof (e9 = o4) || Array.isArray(e9) || null === e9)) throw new Error("Invalid property padding, must be one of: number, object");
  var c9 = "number" == typeof o4 ? { top: o4, right: o4, bottom: o4, left: o4 } : p3({}, k4, o4), d3 = c9.left + c9.right, s4 = c9.top + c9.bottom, h2 = l4 + d3, g4 = a4 + s4, f3 = (r6 - 1) * n6;
  return "row" === i5 ? h2 = l4 * r6 + f3 + d3 : "column" === i5 && (g4 = a4 * r6 + f3 + s4), { width: h2, height: g4, padding: c9 };
};
var b3 = function(t9) {
  var e9 = t9.anchor, i5 = t9.translateX, n6 = t9.translateY, o4 = t9.containerWidth, r6 = t9.containerHeight, l4 = t9.width, a4 = t9.height, c9 = i5, d3 = n6;
  switch (e9) {
    case "top":
      c9 += (o4 - l4) / 2;
      break;
    ...
    case "left":
      ...
      break;
    case "center":
      c9 += (o4 - l4) / 2, d3 += (r6 - a4) / 2;
  }
  return { x: c9, y: d3 };
};
var S2 = function(t9) {
  var e9, i5, n6, o4, r6, l4, a4 = t9.direction, c9 = t9.justify, d3 = t9.symbolSize, s4 = t9.symbolSpacing, h2 = t9.width, g4 = t9.height;
  switch (a4) {
    case "left-to-right":
      e9 = 0, i5 = (g4 - d3) / 2, o4 = g4 / 2, l4 = "central", c9 ? (n6 = h2, r6 = "end") : (n6 = d3 + s4, r6 = "start");
      break;
    case "right-to-left":
      e9 = h2 - d3, i5 = (g4 - d3) / 2, o4 = g4 / 2, l4 = "central", c9 ? (n6 = 0, r6 = "start") : (n6 = h2 - d3 - s4, r6 = "end");
      break;
    case "top-to-bottom":
      e9 = (h2 - d3) / 2, i5 = 0, n6 = h2 / 2, r6 = "middle", c9 ? (o4 = g4, l4 = "alphabetic") : (o4 = d3 + s4, l4 = "text-before-edge");
      break;
    case "bottom-to-top":
      e9 = (h2 - d3) / 2, i5 = g4 - d3, n6 = h2 / 2, r6 = "middle", c9 ? (o4 = 0, l4 = "text-before-edge") : (o4 = g4 - d3 - s4, l4 = "alphabetic");
  }
  return { symbolX: e9, symbolY: i5, labelX: n6, labelY: o4, labelAnchor: r6, labelAlignment: l4 };
};
var w3 = { circle: f2, diamond: m3, square: v4, triangle: u2 };
var X3 = function(i5) {
  var n6, l4, a4, d3, g4, f3, m5, v6, u6, y4, k5, x4 = i5.x, b5 = i5.y, A4 = i5.width, W5 = i5.height, z5 = i5.data, C6 = i5.direction, X4 = void 0 === C6 ? "left-to-right" : C6, Y4 = i5.justify, O5 = void 0 !== Y4 && Y4, B5 = i5.textColor, H3 = i5.background, E4 = void 0 === H3 ? "transparent" : H3, j3 = i5.opacity, L3 = void 0 === j3 ? 1 : j3, M3 = i5.symbolShape, F2 = void 0 === M3 ? "square" : M3, T4 = i5.symbolSize, P4 = void 0 === T4 ? 16 : T4, V2 = i5.symbolSpacing, R = void 0 === V2 ? 8 : V2, D4 = i5.symbolBorderWidth, q2 = void 0 === D4 ? 0 : D4, G = i5.symbolBorderColor, I2 = void 0 === G ? "transparent" : G, N2 = i5.onClick, _2 = i5.onMouseEnter, J2 = i5.onMouseLeave, K3 = i5.toggleSerie, Q2 = i5.effects, U = (0, import_react19.useState)({}), Z = U[0], $2 = U[1], tt2 = zt(), et2 = (0, import_react19.useCallback)(function(t9) {
    if (Q2) {
      var e9 = Q2.filter(function(t10) {
        return "hover" === t10.on;
      }).reduce(function(t10, e11) {
        return p3({}, t10, e11.style);
      }, {});
      $2(e9);
    }
    null == _2 || _2(z5, t9);
  }, [_2, z5, Q2]), it2 = (0, import_react19.useCallback)(function(t9) {
    if (Q2) {
      var e9 = Q2.filter(function(t10) {
        return "hover" !== t10.on;
      }).reduce(function(t10, e11) {
    ...
    null == J2 || J2(z5, t9);
  }, [J2, z5, Q2]), nt2 = S2({ direction: X4, justify: O5, symbolSize: null != (n6 = Z.symbolSize) ? n6 : P4, symbolSpacing: R, width: A4, height: W5 }), ot2 = nt2.symbolX, rt2 = nt2.symbolY, lt2 = nt2.labelX, at2 = nt2.labelY, ct2 = nt2.labelAnchor, dt2 = nt2.labelAlignment, st = [N2, _2, J2, K3].some(function(t9) {
    return void 0 !== t9;
  }), ht2 = "function" == typeof F2 ? F2 : w3[F2];
  return (0, import_jsx_runtime4.jsxs)("g", { transform: "translate(" + x4 + "," + b5 + ")", style: { opacity: null != (l4 = Z.itemOpacity) ? l4 : L3 }, children: [(0, import_jsx_runtime4.jsx)("rect", { width: A4, height: W5, fill: null != (a4 = Z.itemBackground) ? a4 : E4, style: { cursor: st ? "pointer" : "auto" }, onClick: function(t9) {
    null == N2 || N2(z5, t9), null == K3 || K3(z5.id);
  }, onMouseEnter: et2, onMouseLeave: it2 }), c8.createElement(ht2, p3({ id: z5.id, x: ot2, y: rt2, size: null != (d3 = Z.symbolSize) ? d3 : P4, fill: null != (g4 = null != (f3 = z5.fill) ? f3 : z5.color) ? g4 : "black", borderWidth: null != (m5 = Z.symbolBorderWidth) ? m5 : q2, borderColor: null != (v6 = Z.symbolBorderColor) ? v6 : I2 }, z5.hidden ? tt2.legends.hidden.symbol : void 0)), (0, import_jsx_runtime4.jsx)("text", { textAnchor: ct2, style: p3({}, Mt(tt2.legends.text), { fill: null != (u6 = null != (y4 = null != (k5 = Z.itemTextColor) ? k5 : B5) ? y4 : tt2.legends.text.fill) ? u6 : "black", dominantBaseline: dt2, pointerEvents: "none", userSelect: "none" }, z5.hidden ? tt2.legends.hidden.text : void 0), x: lt2, y: at2, children: z5.label })] });
};
var Y3 = function(e9) {
  var i5 = e9.data, n6 = e9.x, o4 = e9.y, r6 = e9.direction, l4 = e9.padding, a4 = void 0 === l4 ? 0 : l4, c9 = e9.justify, d3 = e9.effects, s4 = e9.itemWidth, h2 = e9.itemHeight, g4 = e9.itemDirection, f3 = void 0 === g4 ? "left-to-right" : g4, m5 = e9.itemsSpacing, v6 = void 0 === m5 ? 0 : m5, u6 = e9.itemTextColor, p4 = e9.itemBackground, y4 = void 0 === p4 ? "transparent" : p4, k5 = e9.itemOpacity, b5 = void 0 === k5 ? 1 : k5, S3 = e9.symbolShape, A4 = e9.symbolSize, W5 = e9.symbolSpacing, z5 = e9.symbolBorderWidth, C6 = e9.symbolBorderColor, w5 = e9.onClick, Y4 = e9.onMouseEnter, O5 = e9.onMouseLeave, B5 = e9.toggleSerie, H3 = x3({ itemCount: i5.length, itemWidth: s4, itemHeight: h2, itemsSpacing: v6, direction: r6, padding: a4 }).padding, E4 = "row" === r6 ? s4 + v6 : 0, j3 = "column" === r6 ? h2 + v6 : 0;
  return (0, import_jsx_runtime4.jsx)("g", { transform: "translate(" + n6 + "," + o4 + ")", children: i5.map(function(e11, i6) {
    return (0, import_jsx_runtime4.jsx)(X3, { data: e11, x: i6 * E4 + H3.left, y: i6 * j3 + H3.top, width: s4, height: h2, direction: f3, justify: c9, effects: d3, textColor: u6, background: y4, opacity: b5, symbolShape: S3, symbolSize: A4, symbolSpacing: W5, symbolBorderWidth: z5, symbolBorderColor: C6, onClick: w5, onMouseEnter: Y4, onMouseLeave: O5, toggleSerie: B5 }, i6);
  }) });
};
var O4 = function(e9) {
  var i5 = e9.data, n6 = e9.containerWidth, o4 = e9.containerHeight, r6 = e9.translateX, l4 = void 0 === r6 ? 0 : r6, a4 = e9.translateY, c9 = void 0 === a4 ? 0 : a4, d3 = e9.anchor, s4 = e9.direction, h2 = e9.padding, g4 = void 0 === h2 ? 0 : h2, f3 = e9.justify, m5 = e9.itemsSpacing, v6 = void 0 === m5 ? 0 : m5, u6 = e9.itemWidth, p4 = e9.itemHeight, y4 = e9.itemDirection, k5 = e9.itemTextColor, S3 = e9.itemBackground, A4 = e9.itemOpacity, W5 = e9.symbolShape, z5 = e9.symbolSize, C6 = e9.symbolSpacing, w5 = e9.symbolBorderWidth, X4 = e9.symbolBorderColor, O5 = e9.onClick, B5 = e9.onMouseEnter, H3 = e9.onMouseLeave, E4 = e9.toggleSerie, j3 = e9.effects, L3 = x3({ itemCount: i5.length, itemsSpacing: v6, itemWidth: u6, itemHeight: p4, direction: s4, padding: g4 }), M3 = L3.width, F2 = L3.height, T4 = b3({ anchor: d3, translateX: l4, translateY: c9, containerWidth: n6, containerHeight: o4, width: M3, height: F2 }), P4 = T4.x, V2 = T4.y;
  return (0, import_jsx_runtime4.jsx)(Y3, { data: i5, x: P4, y: V2, direction: s4, padding: g4, justify: f3, effects: j3, itemsSpacing: v6, itemWidth: u6, itemHeight: p4, itemDirection: y4, itemTextColor: k5, itemBackground: S3, itemOpacity: A4, symbolShape: W5, symbolSize: z5, symbolSpacing: C6, symbolBorderWidth: w5, symbolBorderColor: X4, onClick: O5, onMouseEnter: B5, onMouseLeave: H3, toggleSerie: "boolean" == typeof E4 ? void 0 : E4 });
};
var B3 = { start: "left", middle: "center", end: "right" };
var H = function(t9, e9) {
  var i5 = e9.data, n6 = e9.containerWidth, o4 = e9.containerHeight, r6 = e9.translateX, l4 = void 0 === r6 ? 0 : r6, a4 = e9.translateY, c9 = void 0 === a4 ? 0 : a4, d3 = e9.anchor, s4 = e9.direction, h2 = e9.padding, g4 = void 0 === h2 ? 0 : h2, f3 = e9.justify, m5 = void 0 !== f3 && f3, v6 = e9.itemsSpacing, u6 = void 0 === v6 ? 0 : v6, p4 = e9.itemWidth, y4 = e9.itemHeight, k5 = e9.itemDirection, A4 = void 0 === k5 ? "left-to-right" : k5, W5 = e9.itemTextColor, z5 = e9.symbolSize, C6 = void 0 === z5 ? 16 : z5, w5 = e9.symbolSpacing, X4 = void 0 === w5 ? 8 : w5, Y4 = e9.theme, O5 = x3({ itemCount: i5.length, itemWidth: p4, itemHeight: y4, itemsSpacing: u6, direction: s4, padding: g4 }), H3 = O5.width, E4 = O5.height, j3 = O5.padding, L3 = b3({ anchor: d3, translateX: l4, translateY: c9, containerWidth: n6, containerHeight: o4, width: H3, height: E4 }), M3 = L3.x, F2 = L3.y, T4 = "row" === s4 ? p4 + u6 : 0, P4 = "column" === s4 ? y4 + u6 : 0;
  t9.save(), t9.translate(M3, F2), t9.font = Y4.legends.text.fontSize + "px " + (Y4.legends.text.fontFamily || "sans-serif"), i5.forEach(function(e11, i6) {
    var n7, o5, r7 = i6 * T4 + j3.left, l5 = i6 * P4 + j3.top, a5 = S2({ direction: A4, justify: m5, symbolSize: C6, symbolSpacing: X4, width: p4, height: y4 }), c10 = a5.symbolX, d4 = a5.symbolY, s5 = a5.labelX, h3 = a5.labelY, g5 = a5.labelAnchor, f4 = a5.labelAlignment;
    t9.fillStyle = null != (n7 = e11.color) ? n7 : "black", t9.fillRect(r7 + c10, l5 + d4, C6, C6), t9.textAlign = B3[g5], "central" === f4 && (t9.textBaseline = "middle"), t9.fillStyle = null != (o5 = null != W5 ? W5 : Y4.legends.text.fill) ? o5 : "black", t9.fillText(String(e11.label), r7 + s5, l5 + h3);
  }), t9.restore();
};
...
function sum3(elen, e9, flen, f3, h2) {
...
function estimate(elen, e9) {
  let Q2 = e9[0];
  for (let i5 = 1; i5 < elen; i5++) Q2 += e9[i5];
  return Q2;
}
function vec(n6) {
...
var Delaunator = class _Delaunator {
  static from(points, getX = defaultGetX, getY = defaultGetY) {
    ...
    for (let i5 = 0; i5 < n6; i5++) {
      const p4 = points[i5];
      coords[2 * i5] = getX(p4);
      coords[2 * i5 + 1] = getY(p4);
    }
    return new _Delaunator(coords);
  }
  constructor(coords) {
    const n6 = coords.length >> 1;
    if (n6 > 0 && typeof coords[0] !== "number") throw new Error("Expected coords to contain numbers.");
    this.coords = coords;
  ...
  update() {
    ...
    let i0, i1, i22;
    for (let i5 = 0, minDist = Infinity; i5 < n6; i5++) {
    ...
    for (let k5 = 0, xp, yp; k5 < this._ids.length; k5++) {
      ...
      xp = x4;
      yp = y4;
      if (i5 === i0 || i5 === i1 || i5 === i22) continue;
      let start2 = 0;
      ...
      let e9 = start2, q2;
      while (q2 = hullNext[e9], orient2d(x4, y4, coords[2 * e9], coords[2 * e9 + 1], coords[2 * q2], coords[2 * q2 + 1]) >= 0) {
        e9 = q2;
        if (e9 === start2) {
          e9 = -1;
          break;
      ...
      if (e9 === -1) continue;
      let t9 = this._addTriangle(e9, i5, hullNext[e9], -1, -1, hullTri[e9]);
      hullTri[i5] = this._legalize(t9 + 2);
      hullTri[e9] = t9;
      hullSize++;
      let n7 = hullNext[e9];
      while (q2 = hullNext[n7], orient2d(x4, y4, coords[2 * n7], coords[2 * n7 + 1], coords[2 * q2], coords[2 * q2 + 1]) < 0) {
        t9 = this._addTriangle(n7, i5, q2, hullTri[i5], -1, hullTri[n7]);
        hullTri[i5] = this._legalize(t9 + 2);
        hullNext[n7] = n7;
        hullSize--;
        n7 = q2;
      ...
      if (e9 === start2) {
        while (q2 = hullPrev[e9], orient2d(x4, y4, coords[2 * q2], coords[2 * q2 + 1], coords[2 * e9], coords[2 * e9 + 1]) < 0) {
          t9 = this._addTriangle(q2, i5, e9, -1, hullTri[e9], hullTri[q2]);
          this._legalize(t9 + 2);
          hullTri[q2] = t9;
          hullNext[e9] = e9;
          hullSize--;
      ...
      this._hullStart = hullPrev[i5] = e9;
      hullNext[e9] = hullPrev[n7] = i5;
      hullNext[i5] = n7;
      hullHash[this._hashKey(x4, y4)] = i5;
      hullHash[this._hashKey(coords[2 * e9], coords[2 * e9 + 1])] = e9;
    }
    this.hull = new Uint32Array(hullSize);
    for (let i5 = 0, e9 = this._hullStart; i5 < hullSize; i5++) {
      this.hull[i5] = e9;
      e9 = hullNext[e9];
    }
  ...
  _legalize(a4) {
    ...
    while (true) {
      ...
      if (illegal) {
        ...
        if (hbl === -1) {
          let e9 = this._hullStart;
          do {
            if (this._hullTri[e9] === bl) {
              this._hullTri[e9] = a4;
              break;
            }
            e9 = this._hullPrev[e9];
          } while (e9 !== this._hullStart);
        }
        this._link(a4, hbl);
...
function quicksort(ids, dists, left, right) {
  if (right - left <= 20) {
    ...
    if (dists[ids[i5]] > dists[ids[right]]) swap(ids, i5, right);
    if (dists[ids[left]] > dists[ids[i5]]) swap(ids, left, i5);
    const temp = ids[i5];
    const tempDist = dists[temp];
    while (true) {
      do
...
var Path2 = class {
  ...
  arc(x4, y4, r6) {
    ...
    if (!r6) return;
    this._ += `A${r6},${r6},0,1,1,${x4 - r6},${y4}A${r6},${r6},0,1,1,${this._x1 = x0},${this._y1 = y0}`;
  }
  rect(x4, y4, w5, h2) {
...
var Voronoi = class {
  ...
  _init() {
    ...
    for (let i5 = 0, j3 = 0, n6 = triangles.length, x4, y4; i5 < n6; i5 += 3, j3 += 2) {
      const t14 = triangles[i5] * 2;
      ...
      if (Math.abs(ab4) < 1e-9) {
        if (bx === void 0) {
          bx = by = 0;
          for (const i6 of hull) bx += points[i6 * 2], by += points[i6 * 2 + 1];
  ...
  renderCell(i5, context) {
    ...
    while (points[0] === points[n6 - 2] && points[1] === points[n6 - 1] && n6 > 1) n6 -= 2;
  ...
  *cellPolygons() {
    ...
    for (let i5 = 0, n6 = points.length / 2; i5 < n6; ++i5) {
      ...
      if (cell) cell.index = i5, yield cell;
    }
  }
  cellPolygon(i5) {
  ...
  contains(i5, x4, y4) {
    ...
    return this.delaunay._step(i5, x4, y4) === i5;
  }
  *neighbors(i5) {
    const ci = this._clip(i5);
    if (ci) for (const j3 of this.delaunay.neighbors(i5)) {
  ...
  _clip(i5) {
    ...
    const v6 = i5 * 4;
    return this._simplify(V2[v6] || V2[v6 + 1] ? this._clipInfinite(i5, points, V2[v6], V2[v6 + 1], V2[v6 + 2], V2[v6 + 3]) : this._clipFinite(i5, points));
  }
    ...
    for (let j3 = 0; j3 < n6; j3 += 2) {
      ...
      if (c0 === 0 && c12 === 0) {
        ...
        if (c0 === 0) {
          ...
          if (e0 && e1) this._edge(i5, e0, e1, P4, P4.length);
  ...
  _clipInfinite(i5, points, vx0, vy0, vxn, vyn) {
    ...
    if (P4 = this._clipFinite(i5, P4)) {
      for (let j3 = 0, n6 = P4.length, c0, c12 = this._edgecode(P4[n6 - 2], P4[n6 - 1]); j3 < n6; j3 += 2) {
        c0 = c12, c12 = this._edgecode(P4[j3], P4[j3 + 1]);
        if (c0 && c12) j3 = this._edge(i5, c0, c12, P4, j3), n6 = P4.length;
      }
    } else if (this.contains(i5, (this.xmin + this.xmax) / 2, (this.ymin + this.ymax) / 2)) {
  ...
  _edge(i5, e0, e1, P4, j3) {
    while (e0 !== e1) {
      ...
      if ((P4[j3] !== x4 || P4[j3 + 1] !== y4) && this.contains(i5, x4, y4)) {
  ...
  _project(x0, y0, vx, vy) {
    let t9 = Infinity, c9, x4, y4;
    if (vy < 0) {
      if (y0 <= this.ymin) return null;
      if ((c9 = (this.ymin - y0) / vy) < t9) y4 = this.ymin, x4 = x0 + (t9 = c9) * vx;
    } else if (vy > 0) {
      if (y0 >= this.ymax) return null;
      if ((c9 = (this.ymax - y0) / vy) < t9) y4 = this.ymax, x4 = x0 + (t9 = c9) * vx;
    }
    if (vx > 0) {
      if (x0 >= this.xmax) return null;
      if ((c9 = (this.xmax - x0) / vx) < t9) x4 = this.xmax, y4 = y0 + (t9 = c9) * vy;
    } else if (vx < 0) {
      if (x0 <= this.xmin) return null;
      if ((c9 = (this.xmin - x0) / vx) < t9) x4 = this.xmin, y4 = y0 + (t9 = c9) * vy;
    }
    return [x4, y4];
  }
  _edgecode(x4, y4) {
  ...
  _simplify(P4) {
    if (P4 && P4.length > 4) {
      for (let i5 = 0; i5 < P4.length; i5 += 2) {
        const j3 = (i5 + 2) % P4.length, k5 = (i5 + 4) % P4.length;
        if (P4[i5] === P4[j3] && P4[j3] === P4[k5] || P4[i5 + 1] === P4[j3 + 1] && P4[j3 + 1] === P4[k5 + 1]) {
          P4.splice(j3, 2), i5 -= 2;
        }
      }
...
function collinear(d3) {
  ...
  for (let i5 = 0; i5 < triangles.length; i5 += 3) {
    const a4 = 2 * triangles[i5], b5 = 2 * triangles[i5 + 1], c9 = 2 * triangles[i5 + 2], cross2 = (coords[c9] - coords[a4]) * (coords[b5 + 1] - coords[a4 + 1]) - (coords[b5] - coords[a4]) * (coords[c9 + 1] - coords[a4 + 1]);
    if (cross2 > 1e-10) return false;
  }
  return true;
}
function jitter(x4, y4, r6) {
  return [x4 + Math.sin(x4 + y4) * r6, y4 + Math.cos(x4 - y4) * r6];
}
var Delaunay = class _Delaunay {
  ...
  _init() {
    ...
    if (d3.hull && d3.hull.length > 2 && collinear(d3)) {
      this.collinear = Int32Array.from({ length: points.length / 2 }, (_2, i5) => i5).sort((i5, j3) => points[2 * i5] - points[2 * j3] || points[2 * i5 + 1] - points[2 * j3 + 1]);
      const e9 = this.collinear[0], f3 = this.collinear[this.collinear.length - 1], bounds = [points[2 * e9], points[2 * e9 + 1], points[2 * f3], points[2 * f3 + 1]], r6 = 1e-8 * Math.hypot(bounds[3] - bounds[1], bounds[2] - bounds[0]);
      for (let i5 = 0, n6 = points.length / 2; i5 < n6; ++i5) {
        const p4 = jitter(points[2 * i5], points[2 * i5 + 1], r6);
        points[2 * i5] = p4[0];
        points[2 * i5 + 1] = p4[1];
      }
      this._delaunator = new Delaunator(points);
    ...
    for (let e9 = 0, n6 = halfedges.length; e9 < n6; ++e9) {
      const p4 = triangles[e9 % 3 === 2 ? e9 - 2 : e9 + 1];
      if (halfedges[e9] === -1 || inedges[p4] === -1) inedges[p4] = e9;
    }
  ...
  *neighbors(i5) {
    ...
    if (collinear2) {
      const l4 = collinear2.indexOf(i5);
    ...
    let e9 = e0, p0 = -1;
    do {
      yield p0 = triangles[e9];
      e9 = e9 % 3 === 2 ? e9 - 2 : e9 + 1;
      if (triangles[e9] !== i5) return;
      e9 = halfedges[e9];
      if (e9 === -1) {
        const p4 = hull[(_hullIndex[i5] + 1) % hull.length];
        if (p4 !== p0) yield p4;
        return;
      }
    } while (e9 !== e0);
  ...
  find(x4, y4, i5 = 0) {
    ...
    const i0 = i5;
    let c9;
    while ((c9 = this._step(i5, x4, y4)) >= 0 && c9 !== i5 && c9 !== i0) i5 = c9;
    return c9;
  }
  _step(i5, x4, y4) {
    ...
    let c9 = i5;
    let dc = pow2(x4 - points[i5 * 2], 2) + pow2(y4 - points[i5 * 2 + 1], 2);
    const e0 = inedges[i5];
    let e9 = e0;
    do {
      let t9 = triangles[e9];
      const dt2 = pow2(x4 - points[t9 * 2], 2) + pow2(y4 - points[t9 * 2 + 1], 2);
      if (dt2 < dc) dc = dt2, c9 = t9;
      e9 = e9 % 3 === 2 ? e9 - 2 : e9 + 1;
      if (triangles[e9] !== i5) break;
      e9 = halfedges[e9];
      if (e9 === -1) {
        e9 = hull[(_hullIndex[i5] + 1) % hull.length];
        if (e9 !== t9) {
          if (pow2(x4 - points[e9 * 2], 2) + pow2(y4 - points[e9 * 2 + 1], 2) < dc) return e9;
        }
        break;
      }
    } while (e9 !== e0);
  ...
  renderPoints(context, r6) {
    ...
    for (let i5 = 0, n6 = points.length; i5 < n6; i5 += 2) {
      const x4 = points[i5], y4 = points[i5 + 1];
      context.moveTo(x4 + r6, y4);
      context.arc(x4, y4, r6, 0, tau3);
    }
    return buffer && buffer.value();
  }
  renderHull(context) {
    ...
    const h2 = hull[0] * 2, n6 = hull.length;
  ...
  renderTriangle(i5, context) {
    ...
    const t04 = triangles[i5 *= 3] * 2;
    const t14 = triangles[i5 + 1] * 2;
...
function flatArray(points, fx, fy, that) {
  const n6 = points.length;
  const array2 = new Float64Array(n6 * 2);
  for (let i5 = 0; i5 < n6; ++i5) {
    const p4 = points[i5];
    array2[i5 * 2] = fx.call(that, p4, i5, points);
    array2[i5 * 2 + 1] = fy.call(that, p4, i5, points);
  }
  return array2;
}
function* flatIterable(points, fx, fy, that) {
  ...
  for (const p4 of points) {
    yield fx.call(that, p4, i5, points);
    yield fy.call(that, p4, i5, points);
    ++i5;
  }
}
...
var P3 = "top";
var w4 = function(n6) {
  var o4 = n6.points, e9 = n6.getNodePosition, i5 = void 0 === e9 ? C5 : e9, t9 = n6.margin, r6 = void 0 === t9 ? L2 : t9;
  return o4.map(function(n7) {
    var o5 = i5(n7), e11 = o5[0], t10 = o5[1];
    return [e11 + r6.left, t10 + r6.top];
  });
};
var E3 = function(n6) {
  var o4 = n6.points, e9 = n6.width, i5 = n6.height, t9 = n6.margin, r6 = void 0 === t9 ? L2 : t9, l4 = n6.debug, u6 = Delaunay.from(o4), a4 = l4 ? u6.voronoi([0, 0, r6.left + e9 + r6.right, r6.top + i5 + r6.bottom]) : void 0;
  return { points: o4, delaunay: u6, voronoi: a4 };
};
var W4 = function(o4) {
  var e9 = o4.points, i5 = o4.getNodePosition, t9 = void 0 === i5 ? C5 : i5, r6 = o4.width, l4 = o4.height, u6 = o4.margin, a4 = void 0 === u6 ? L2 : u6, d3 = o4.debug;
  return (0, import_react20.useMemo)(function() {
    return E3({ points: w4({ points: e9, margin: a4, getNodePosition: t9 }), width: r6, height: l4, margin: a4, debug: d3 });
  }, [e9, r6, l4, a4, d3]);
};
var D3 = function(r6) {
  var l4 = r6.elementRef, u6 = r6.nodes, s4 = r6.getNodePosition, c9 = void 0 === s4 ? C5 : s4, h2 = r6.delaunay, v6 = r6.setCurrent, f3 = r6.margin, p4 = void 0 === f3 ? L2 : f3, m5 = r6.detectionRadius, M3 = void 0 === m5 ? 1 / 0 : m5, b5 = r6.isInteractive, k5 = void 0 === b5 || b5, y4 = r6.onMouseEnter, w5 = r6.onMouseMove, E4 = r6.onMouseLeave, W5 = r6.onClick, x4 = r6.onTouchStart, S3 = r6.onTouchMove, D4 = r6.onTouchEnd, R = r6.enableTouchCrosshair, A4 = void 0 !== R && R, N2 = r6.tooltip, O5 = r6.tooltipPosition, j3 = void 0 === O5 ? T3 : O5, I2 = r6.tooltipAnchor, z5 = void 0 === I2 ? P3 : I2, F2 = (0, import_react20.useState)(null), H3 = F2[0], B5 = F2[1], q2 = (0, import_react20.useRef)(null);
  (0, import_react20.useEffect)(function() {
    q2.current = H3;
  }, [q2, H3]);
  var G = (0, import_react20.useCallback)(function(n6) {
    if (!l4.current) return null;
    var o4 = Sn(l4.current, n6), e9 = o4[0], i5 = o4[1], t9 = h2.find(e9, i5), r7 = void 0 !== t9 ? u6[t9] : null;
    if (r7 && M3 !== 1 / 0) {
      var s5 = c9(r7), v7 = s5[0], f4 = s5[1];
      Mn(e9, i5, v7 + p4.left, f4 + p4.top) > M3 && (t9 = null, r7 = null);
    }
    return null === t9 || null === r7 ? null : [t9, r7];
  }, [l4, h2, u6, c9, p4, M3]), J2 = k2(), K3 = J2.showTooltipAt, Q2 = J2.showTooltipFromEvent, U = J2.hideTooltip, V2 = (0, import_react20.useMemo)(function() {
    if (N2) return "cursor" === j3 ? function(n6, o4) {
      Q2(N2(n6), o4, z5);
    } : function(n6) {
      var o4 = c9(n6), e9 = o4[0], i5 = o4[1];
      K3(N2(n6), [e9 + p4.left, i5 + p4.top], z5);
    };
  }, [K3, Q2, N2, j3, z5, c9, p4]), X4 = (0, import_react20.useCallback)(function(n6) {
    var o4 = G(n6);
    if (B5(o4), null == v6 || v6(o4 ? o4[1] : null), o4) {
      var e9 = o4[1];
      null == V2 || V2(e9, n6), null == y4 || y4(o4[1], n6);
    }
  }, [G, B5, v6, V2, y4]), Y4 = (0, import_react20.useCallback)(function(n6) {
    var o4 = G(n6);
    if (B5(o4), o4) {
      var e9 = o4[0], i5 = o4[1];
      if (null == v6 || v6(i5), null == V2 || V2(i5, n6), q2.current) {
        var t9 = q2.current, r7 = t9[0], l5 = t9[1];
        e9 !== r7 ? null == E4 || E4(l5, n6) : null == w5 || w5(i5, n6);
      } else null == y4 || y4(i5, n6);
    } else null == v6 || v6(null), null == U || U(), q2.current && (null == E4 || E4(q2.current[1], n6));
  }, [G, B5, q2, y4, w5, E4, V2, U]), Z = (0, import_react20.useCallback)(function(n6) {
    B5(null), null == v6 || v6(null), U(), E4 && q2.current && E4(q2.current[1], n6);
  }, [B5, v6, q2, U, E4]), $2 = (0, import_react20.useCallback)(function(n6) {
    var o4 = G(n6);
    B5(o4), o4 && (null == W5 || W5(o4[1], n6));
  }, [G, B5, W5]), _2 = (0, import_react20.useCallback)(function(n6) {
    var o4 = G(n6);
    A4 && (B5(o4), null == v6 || v6(o4 ? o4[1] : null)), o4 && (null == x4 || x4(o4[1], n6));
  }, [G, B5, v6, A4, x4]), nn3 = (0, import_react20.useCallback)(function(n6) {
    var o4 = G(n6);
    A4 && (B5(o4), null == v6 || v6(o4 ? o4[1] : null)), o4 && (null == S3 || S3(o4[1], n6));
  }, [G, B5, v6, A4, S3]), on3 = (0, import_react20.useCallback)(function(n6) {
    A4 && (B5(null), null == v6 || v6(null)), D4 && q2.current && D4(q2.current[1], n6);
  }, [A4, B5, v6, D4, q2]);
  return { current: H3, handleMouseEnter: k5 ? X4 : void 0, handleMouseMove: k5 ? Y4 : void 0, handleMouseLeave: k5 ? Z : void 0, handleClick: k5 ? $2 : void 0, handleTouchStart: k5 ? _2 : void 0, handleTouchMove: k5 ? nn3 : void 0, handleTouchEnd: k5 ? on3 : void 0 };
};
var I = function(o4) {
  var i5 = o4.nodes, t9 = o4.width, r6 = o4.height, l4 = o4.margin, u6 = void 0 === l4 ? L2 : l4, a4 = o4.getNodePosition, d3 = o4.setCurrent, s4 = o4.onMouseEnter, c9 = o4.onMouseMove, h2 = o4.onMouseLeave, v6 = o4.onClick, f3 = o4.onTouchStart, p4 = o4.onTouchMove, g4 = o4.onTouchEnd, k5 = o4.enableTouchCrosshair, y4 = void 0 !== k5 && k5, C6 = o4.detectionRadius, w5 = void 0 === C6 ? 1 / 0 : C6, E4 = o4.tooltip, x4 = o4.tooltipPosition, S3 = void 0 === x4 ? T3 : x4, R = o4.tooltipAnchor, A4 = void 0 === R ? P3 : R, N2 = o4.debug, O5 = (0, import_react20.useRef)(null), j3 = W4({ points: i5, getNodePosition: a4, width: t9, height: r6, margin: u6, debug: N2 }), I2 = j3.delaunay, z5 = j3.voronoi, F2 = D3({ elementRef: O5, nodes: i5, delaunay: I2, margin: u6, detectionRadius: w5, setCurrent: d3, onMouseEnter: s4, onMouseMove: c9, onMouseLeave: h2, onClick: v6, onTouchStart: f3, onTouchMove: p4, onTouchEnd: g4, enableTouchCrosshair: y4, tooltip: E4, tooltipPosition: S3, tooltipAnchor: A4 }), H3 = F2.current, B5 = F2.handleMouseEnter, q2 = F2.handleMouseMove, G = F2.handleMouseLeave, J2 = F2.handleClick, K3 = F2.handleTouchStart, Q2 = F2.handleTouchMove, U = F2.handleTouchEnd, V2 = (0, import_react20.useMemo)(function() {
    if (N2 && z5) return z5.render();
  }, [N2, z5]);
  return (0, import_jsx_runtime5.jsxs)("g", { ref: O5, transform: "translate(" + -u6.left + "," + -u6.top + ")", children: [N2 && z5 && (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [(0, import_jsx_runtime5.jsx)("path", { d: V2, stroke: "red", strokeWidth: 1, opacity: 0.75 }), w5 < 1 / 0 && (0, import_jsx_runtime5.jsx)("path", { stroke: "red", strokeWidth: 0.35, fill: "none", d: I2.renderPoints(void 0, w5) }), H3 && (0, import_jsx_runtime5.jsx)("path", { fill: "pink", opacity: 0.35, d: z5.renderCell(H3[0]) })] }), (0, import_jsx_runtime5.jsx)("rect", { "data-ref": "mesh-interceptor", width: u6.left + t9 + u6.right, height: u6.top + r6 + u6.bottom, fill: "red", opacity: 0, style: { cursor: "auto" }, onMouseEnter: B5, onMouseMove: q2, onMouseLeave: G, onTouchStart: K3, onTouchMove: Q2, onTouchEnd: U, onClick: J2 })] });
};
var z4 = function(n6, o4) {
  n6.save(), n6.globalAlpha = 0.75, n6.beginPath(), o4.render(n6), n6.strokeStyle = "red", n6.lineWidth = 1, n6.stroke(), n6.restore();
};
var H2 = function(n6, o4, e9) {
  n6.save(), n6.globalAlpha = 0.35, n6.beginPath(), o4.renderCell(e9, n6), n6.fillStyle = "pink", n6.fill(), n6.restore();
};
...
//# sourceMappingURL=chunk-L77Z67YN.js.map
